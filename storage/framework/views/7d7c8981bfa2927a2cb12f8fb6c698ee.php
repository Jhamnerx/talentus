...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Eliminar Registro','wire:model.live' => 'modalDelete','width' => 'md']); ?>
    ...
    <div class="flex gap-4">
        ...
        <div class="flex-1">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                EstÃ¡s seguro de eliminar este certificado?.
            </p>
        </div>
    </div>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['negative' => true,'label' => 'Sí, Eliminar','wire:click' => 'delete']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/certificados/velocimetros/delete.blade.php ENDPATH**/ ?>