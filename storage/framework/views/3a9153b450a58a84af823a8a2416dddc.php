...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Eliminar Categoría','wire:model' => 'modalDelete','width' => 'md']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                ¿Estás seguro de eliminar la categoría <strong><?php echo e($categoria?->nombre); ?></strong>? Esta acción no
                se puede deshacer.
            </p>
        </div>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Eliminar','wire:click' => 'delete','negative' => true,'spinner' => 'delete']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/categorias/delete-modal.blade.php ENDPATH**/ ?>