...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Registrar Lineas','blur' => true,'wire:model.live' => 'modalCreate','align' => 'center','max-width' => '3xl']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'número de linea','wire:model.live' => 'items.'.e($clave).'.numero']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'ingresa operador','wire:model.live.change' => 'items.'.e($clave).'.operador']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/lineas/save.blade.php ENDPATH**/ ?>