...
<?php endif; ?>
<?php $component->withAttributes(['disabled' => true,'label' => 'Selecciona una Vehiculo:','wire:model.live' => 'vehiculo_id','placeholder' => 'Selecciona una placa','option-description' => 'option_description','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('api.vehiculos.index')),'option-label' => 'placa','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/vehiculos/mantenimiento/edit.blade.php ENDPATH**/ ?>