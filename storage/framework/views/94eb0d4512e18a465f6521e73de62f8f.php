<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-384 mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Export button -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('exportar-cliente')): ?>
                <div class="relative inline-flex">
                    <a href="<?php echo e(route('admin.export.clientes')); ?>">
                        <button
            ...
            <!-- Import button -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('importar-cliente')): ?>
                <div class="relative inline-flex">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver-contacto')): ?>
                <div class="relative inline-flex">
                    <a href="<?php echo e(route('admin.clientes.contactos.index')); ?>">
                        <button
    ...
    <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-gray-800 dark:text-gray-100">Total Clientes <span
                    class="text-gray-400 dark:text-gray-500 font-medium"><?php echo e($clientes->total()); ?></span>
            </h2>
        </header>
                ...
                <table class="table-auto w-full dark:text-gray-300">
                    ...
                    <thead
                        ...
                        <tr>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cambiar.estado-cliente')): ?>
                                <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('', get_defined_vars()); ?>wire:key='client-<?php echo e($cliente->id); ?>'>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left">
                                        <?php echo e($cliente->tipoDocumento ? $cliente->tipoDocumento->descripcion : ''); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left"><?php echo e($cliente->numero_documento); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left"><?php echo e($cliente->email); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-center"><?php echo e($cliente->telefono); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left font-medium text-sky-600"><?php echo e($cliente->web_site); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cambiar.estado-cliente')): ?>
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div class="text-center">
                                            <div class="m-3 w-48">
                                                <div class="flex items-center mt-2" x-data="{ checked: <?php echo e($cliente->is_active ? 'true' : 'false'); ?> }">
                                                    <span class="text-sm mr-3 text-gray-600 dark:text-gray-300">Activo:
                                                    </span>
                                                    <div class="form-switch">
                                                        <input wire:click="toggleStatus(<?php echo e($cliente->id); ?>)"
                                                            type="checkbox" id="switch-f<?php echo e($cliente->id); ?>"
                                                            class="sr-only" x-model="checked" />
                                                        <label class="bg-gray-400 dark:bg-gray-700"
                                                            for="switch-f<?php echo e($cliente->id); ?>">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-cliente')): ?>
                                            <button wire:click.prevent='openModalEdit(<?php echo e($cliente->id); ?>)'
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-cliente')): ?>
                                            <button wire:click.prevent='openModalDelete(<?php echo e($cliente->id); ?>)'
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($clientes->count() < 1): ?>
                            <tr>
                                <td colspan="10"
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/clientes/clientes-index.blade.php ENDPATH**/ ?>