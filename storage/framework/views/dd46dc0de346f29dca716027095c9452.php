...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Crear Producto','blur' => true,'wire:model.live' => 'modalCreate','align' => 'center']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'descripcion','name' => 'descripcion','wire:model' => 'descripcion','label' => 'Descripción:','placeholder' => 'Descripcion del producto']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'categoria_id','name' => 'categoria_id','label' => 'Selecciona una categoria','wire:model.live' => 'categoria_id','placeholder' => 'Selecciona una categoria','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
...
<?php endif; ?>
        ...
        <div class="col-span-12 md:col-span-4 <?php echo e($es_dispositivo ? '' : 'hidden'); ?>">
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Modelo Vinculado:','name' => 'modelo_id','wire:model.live' => 'modelo_id','placeholder' => 'Selecciona un modelo','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'codigo','name' => 'codigo','wire:model.live' => 'codigo','label' => 'Codigo:','placeholder' => 'Codigo del producto']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'unit_code','name' => 'unit_code','label' => 'Unidad:','wire:model.live' => 'unit_code','placeholder' => 'Selecciona una opcion','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('api.unit.index')),'option-label' => 'name','option-value' => 'codigo']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'stock','name' => 'stock','wire:model' => 'stock','label' => 'Stock:']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'divisa_p','label' => 'Divisa:','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['name' => 'SOLES', 'id' => 'PEN'], ['name' => 'DOLARES', 'id' => 'USD']]),'option-label' => 'name','option-value' => 'id','wire:model' => 'divisa','clearable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'icon' => 'currency-dollar']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'valor_unitario','name' => 'valor_unitario','label' => 'Valor unitario:','placeholder' => '9.99','icon' => 'currency-dollar','precision' => '4','wire:model.live.blur' => 'valor_unitario']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Currency::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'precio_unitario','name' => 'precio_unitario','label' => 'Precio unitario:','placeholder' => '9.99','icon' => 'currency-dollar','precision' => '4','wire:model.live.blur' => 'precio_unitario']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'es_dispositivo','name' => 'es_dispositivo','md' => true,'left-label' => '¿Es un Dispositivo?','wire:model.live' => 'es_dispositivo']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Switcher\Checkbox::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'afecto_icbper','name' => 'afecto_icbper','md' => true,'left-label' => 'Afecto icbper?','wire:model' => 'afecto_icbper']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        $(document).ready(function() {
            ...
            imagen.on('addfile', (error, file) => {
                ...
                reader.onloadend = () => {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('file', base64String);
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/productos/create-modal.blade.php ENDPATH**/ ?>