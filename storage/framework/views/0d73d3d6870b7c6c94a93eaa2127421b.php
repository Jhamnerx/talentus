<div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">Ventas <span class="text-slate-400 font-medium"><?php echo e($notas->total()); ?></span></h2>
    </header>
    <div>
            ...
            <table class="table-auto  w-full">
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">DOC. AFECTADO</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $notas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr>

                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div><?php echo e($nota->fecha_emision->format('d-m-Y / H:i:s')); ?>

                            </div>
                        </td>
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium text-sky-500">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($nota->tipo_comprobante_id):
                                case ('07'): ?>
                                NOTA DE CRÉDITO <?php echo e($nota->serie_correlativo); ?>

                                <?php break; ?>

                                <?php case ('08'): ?>
                                NOTA DE DEBITO <?php echo e($nota->serie_correlativo); ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3">
                            <div class="font-medium text-slate-900">
                                <?php echo e($nota->cliente->razon_social); ?>

                            </div>
                            <div class="font-sm text-slate-700">
                                <p class="text-xs">
                                    <?php echo e($nota->cliente->numero_documento); ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3">
                            ...
                            <div class="font-medium text-sky-500">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nota->comprobante): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($nota->comprobante->tipo_comprobante_id):
                                case ('01'): ?>
                                FACTURA-<?php echo e($nota->comprobante->serie_correlativo); ?>

                                <?php break; ?>

                                <?php case ('02'): ?>
                                NOTA DE VENTA-<?php echo e($nota->comprobante->serie_correlativo); ?>

                                <?php break; ?>

                                <?php case ('03'): ?>
                                BOLETA DE VENTA-<?php echo e($nota->comprobante->serie_correlativo); ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium text-emerald-500">
                                ...
                                <?php echo e($nota->sustento->descripcion); ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nota->tipo_comprobante_id != '02'): ?>
                            <div class="space-x-1">

                                
                                <a target="_blank"
                                    href="<?php echo e(route('facturacion.nota.ver.pdf', ['comprobantes' => $nota, 'id' => $nota->id])); ?>">
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px text-center">
                            ...
                            <div class="space-x-1">
                                ...
                                <a href="<?php echo e(route('facturacion.nota.ver.xml', $nota)); ?>">
                                    <button type="button" class="bg-white">
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            ...
                            <div class="space-x-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($nota->fe_estado):
...
<?php endif; ?>
<?php $component->withAttributes(['flat' => true,'wire:click.prevent' => 'getCdr('.e($nota->id).')','teal' => true,'icon' => 'arrow-path','spinner' => 'getCdr('.e($nota->id).')']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['indigo' => true,'md' => true,'label' => ''.e($nota->serie_correlativo).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Badge\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['indigo' => true,'md' => true,'label' => ''.e($nota->estado_texto).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Badge\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['indigo' => true,'md' => true,'label' => ''.e($nota->code_sunat).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                            ...
                                            <div
                                                ...
                                                <div class="w-full mx-2">
                                                    ...
                                                    <span><?php echo e($nota->fe_mensaje_sunat); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php endif; ?>
                                            ...
                                            <div
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <?php echo e($nota->fe_mensaje_sunat); ?>
                                            ...
                                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $nota->nota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $nota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <tr
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notas->count() < 1): ?> <tr>
...
</div><?php /**PATH C:\laragon2\www\talentus\resources\views/components/admin/facturacion/notas-table.blade.php ENDPATH**/ ?>