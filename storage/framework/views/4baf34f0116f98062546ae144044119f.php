            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="mb-1 text-center w-full" wire:loading wire:target="sendRecibo">
                ...
                <div class="px-5 py-4 border-t border-slate-200">
                    <div class="flex flex-wrap justify-end space-x-2">
                        ...
                        <button wire:loading.attr="disabled" wire:target="sendRecibo"
                            class="btn-sm bg-indigo-500 hover:bg-indigo-600 disabled:bg-indigo-300 text-white"
                            wire:click="sendRecibo">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/ventas/recibos/send.blade.php ENDPATH**/ ?>