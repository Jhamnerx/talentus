...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'EXPORTAR PAGOS','wire:model' => 'modalExport','blur' => true,'max-width' => '2xl']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Método de Pago','wire:model.defer' => 'payment_method_id','placeholder' => 'Todos los métodos','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($paymentMethods),'option-label' => 'description','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha Desde','wire:model.defer' => 'from','without-time' => true,'parse-format' => 'YYYY-MM-DD','placeholder' => 'Seleccione fecha inicial']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\DatetimePicker\Picker::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha Hasta','wire:model.defer' => 'to','without-time' => true,'parse-format' => 'YYYY-MM-DD','placeholder' => 'Seleccione fecha final']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Exportar','wire:click' => 'exportar','spinner' => 'exportar','icon' => 'arrow-down-tray']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/payments/export-payments.blade.php ENDPATH**/ ?>