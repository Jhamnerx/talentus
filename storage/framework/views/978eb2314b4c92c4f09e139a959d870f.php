...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Desde:','wire:model.live' => 'from','without-time' => true,'parse-format' => 'YYYY-MM-DD','display-format' => 'DD-MM-YYYY']); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\DatetimePicker\Picker::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Hasta:','wire:model.live' => 'to','without-time' => true,'parse-format' => 'YYYY-MM-DD','display-format' => 'DD-MM-YYYY']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Hoy','wire:click' => 'filter(1)','sm' => true,'flat' => true,'primary' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '7 días','wire:click' => 'filter(7)','sm' => true,'flat' => true,'secondary' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '3 Meses','wire:click' => 'filter(90)','sm' => true,'flat' => true,'warning' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Mes Pasado','wire:click' => 'filter(\'last_month\')','sm' => true,'flat' => true,'info' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Este Mes','wire:click' => 'filter(30)','sm' => true,'flat' => true,'positive' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="mt-2 text-center text-xs text-gray-500 dark:text-gray-400">
            Mostrando datos desde <?php echo e(date('d/m/Y', strtotime($from))); ?> hasta <?php echo e(date('d/m/Y', strtotime($to))); ?>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">S/
                        <?php echo e(number_format($saldoTotalCajasPen, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">USD</span>
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">$
                        <?php echo e(number_format($saldoTotalCajasUsd, 2)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700/60 p-5">
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">PEN</span>
                    <span
                        class="text-lg font-semibold <?php echo e($balancePen >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'); ?>">
                        <?php echo e($balancePen >= 0 ? '+' : ''); ?>S/ <?php echo e(number_format($balancePen, 2)); ?>
                ...
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">USD</span>
                    <span
                        class="text-lg font-semibold <?php echo e($balanceUsd >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'); ?>">
                        <?php echo e($balanceUsd >= 0 ? '+' : ''); ?>$ <?php echo e(number_format($balanceUsd, 2)); ?>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700/60 p-5">
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">PEN</span>
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">S/
                        <?php echo e(number_format($totalPorCobrarPen, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">USD</span>
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">$
                        <?php echo e(number_format($totalPorCobrarUsd, 2)); ?></span>
                </div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cuentasVencidas > 0): ?>
                <div class="mt-2 text-xs text-rose-600 dark:text-rose-400 font-medium">
                    ⚠ <?php echo e($cuentasVencidas); ?> doc(s) vencido(s)
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700/60 p-5">
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">PEN</span>
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">S/
                        <?php echo e(number_format($totalPorPagarPen, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">USD</span>
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">$
                        <?php echo e(number_format($totalPorPagarUsd, 2)); ?></span>
                </div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cuentasPorPagarVencidas > 0): ?>
                <div class="mt-2 text-xs text-rose-600 dark:text-rose-400 font-medium">
                    ⚠ <?php echo e($cuentasPorPagarVencidas); ?> doc(s) vencido(s)
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-semibold text-emerald-900 dark:text-emerald-100">S/
                        <?php echo e(number_format($facturadoYPagadoPen, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-semibold text-emerald-900 dark:text-emerald-100">$
                        <?php echo e(number_format($facturadoYPagadoUsd, 2)); ?></span>
                </div>
            </div>
            <div class="mt-2 text-xs text-emerald-600 dark:text-emerald-400">
                <?php echo e($documentosPagados); ?> documento(s) pagado(s)
            </div>
        </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-semibold text-blue-900 dark:text-blue-100">S/
                        <?php echo e(number_format($facturadoPendientePen, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-semibold text-blue-900 dark:text-blue-100">$
                        <?php echo e(number_format($facturadoPendienteUsd, 2)); ?></span>
                </div>
            </div>
            <div class="mt-2 text-xs text-blue-600 dark:text-blue-400">
                <?php echo e($documentosPendientes); ?> documento(s) por cobrar
            </div>
        </div>
    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <span class="text-sm font-semibold text-emerald-600 dark:text-emerald-400">S/
                                <?php echo e(number_format($ingresosPen, 2)); ?></span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <?php $totalPen = $ingresosPen + $egresosPen; ?>
                            <div class="bg-emerald-500 h-2 rounded-full"
                                style="width: <?php echo e($totalPen > 0 ? ($ingresosPen / $totalPen) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <span class="text-sm font-semibold text-rose-600 dark:text-rose-400">S/
                                <?php echo e(number_format($egresosPen, 2)); ?></span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div class="bg-rose-500 h-2 rounded-full"
                                style="width: <?php echo e($totalPen > 0 ? ($egresosPen / $totalPen) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <span class="text-sm font-semibold text-emerald-600 dark:text-emerald-400">$
                                <?php echo e(number_format($ingresosUsd, 2)); ?></span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <?php $totalUsd = $ingresosUsd + $egresosUsd; ?>
                            <div class="bg-emerald-500 h-2 rounded-full"
                                style="width: <?php echo e($totalUsd > 0 ? ($ingresosUsd / $totalUsd) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <span class="text-sm font-semibold text-rose-600 dark:text-rose-400">$
                                <?php echo e(number_format($egresosUsd, 2)); ?></span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div class="bg-rose-500 h-2 rounded-full"
                                style="width: <?php echo e($totalUsd > 0 ? ($egresosUsd / $totalUsd) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Soles
                        (PEN)</span>
                    <span
                        class="text-2xl font-bold <?php echo e($liquidezNetaPen >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'); ?>">
                        S/ <?php echo e(number_format($liquidezNetaPen, 2)); ?>
            ...
            <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                <div class="flex justify-between items-center mb-2">
                    <span
                        ...
                        (USD)</span>
                    <span
                        class="text-2xl font-bold <?php echo e($liquidezNetaUsd >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'); ?>">
                        $ <?php echo e(number_format($liquidezNetaUsd, 2)); ?>
                ...
                <div class="grid grid-cols-3 gap-2 text-center text-xs">
                    <div>
                        <div class="text-gray-500 dark:text-gray-400">Caja</div>
                        <div class="font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(number_format($saldoTotalCajasUsd, 2)); ?></div>
                    </div>
                    <div>
                        <div class="text-gray-500 dark:text-gray-400">+ Cobrar</div>
                        <div class="font-semibold text-blue-600 dark:text-blue-400">
                            <?php echo e(number_format($totalPorCobrarUsd, 0)); ?></div>
                    </div>
                    <div>
                        <div class="text-gray-500 dark:text-gray-400">− Pagar</div>
                        <div class="font-semibold text-amber-600 dark:text-amber-400">
                            <?php echo e(number_format($totalPorPagarUsd, 0)); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/finanzas/balance/index.blade.php ENDPATH**/ ?>