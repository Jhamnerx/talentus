...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'pagos_detalle.'.e($index).'.metodo_pago_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->paymentMethods
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'pagos_detalle.'.e($index).'.payment_destination_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->paymentDestinations->toArray()),'option-label' => 'description','option-value' => 'id','placeholder' => 'Seleccione destino']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'pagos_detalle.'.e($index).'.referencia','placeholder' => 'Nro. operación']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click.prevent' => 'save','spinner' => 'save','label' => 'EDITAR RECIBO','black' => true,'md' => true,'icon' => 'shopping-cart']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            <?php echo e($pendingGpsItem['producto'] ?? ''); ?>
                ...
                <div class="px-6 pt-3">
                    <div class="flex items-center justify-between mb-1">
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">
                            Progreso: <strong><?php echo e($selected); ?></strong> / <strong><?php echo e($needed); ?></strong>
                        </span>
                        <span class="text-xs text-slate-400">
                            <?php echo e($needed - $selected); ?> restante(s)
                        </span>
                    </div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-1.5">
                        <div class="bg-indigo-500 h-1.5 rounded-full transition-all"
                            style="width: <?php echo e($needed > 0 ? round(($selected / $needed) * 100) : 0); ?>%">
                        </div>
                    </div>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedImeis) > 0): ?>
                    <div class="px-6 pt-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $selectedImeis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sIndex => $sel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <span
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/ventas/recibos/edit.blade.php ENDPATH**/ ?>