...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'EDITAR PAGO','wire:model' => 'modalEdit','blur' => true,'max-width' => '2xl']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tipo Pago','wire:model.live' => 'tipo_pago']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Método de Pago','wire:model.defer' => 'payment_method_id','placeholder' => 'Seleccione un método','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($paymentMethods),'option-label' => 'description','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Actualizar','wire:click' => 'update']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/payments/edit.blade.php ENDPATH**/ ?>