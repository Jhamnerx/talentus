<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Add  button -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear-dispositivo')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver.modelos-dispositivo')): ?>
                <a href="<?php echo e(route('admin.almacen.modelos-dispositivos')); ?>"
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Export button -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('exportar-dispositivo')): ?>
                    <div class="relative inline-flex">
                        <a href="<?php echo e(route('admin.export.dispositivos')); ?>">
                            <button
                ...
                <!-- Import button -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('importar-dispositivo')): ?>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-slate-200 dark:border-gray-700">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800 dark:text-gray-100">Total dispositivos <span
                    class="text-slate-400 dark:text-gray-400 font-medium"><?php echo e($dispositivos->total()); ?></span>
            </h2>
            ...
            <div class="overflow-x-auto min-h-screen">
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-slate-200 dark:divide-gray-700">
                        <!-- Row -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dispositivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispositivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('device-{{ $dispositivo->id }}', get_defined_vars()); ?>wire:key="device-<?php echo e($dispositivo->id); ?>">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivo->modelo->image): ?>
                                                <img class="ml-1"
                                                    src="<?php echo e(Storage::url($dispositivo->modelo->image->url)); ?>.webp"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivo->of_client): ?>
                                            <div class="font-medium text-blue-400 dark:text-blue-300">
                                                <?php echo e($dispositivo->imei); ?></div>
                                        <?php else: ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left text-slate-800 dark:text-gray-200">
                                        <?php echo e($dispositivo->modelo->modelo); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left text-slate-800 dark:text-gray-200">
                                        <?php echo e($dispositivo->modelo->marca); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivo->in_fota): ?>
                                        <div class="text-left">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($dispositivo->vehiculoActual())): ?>
                                        <div class="font-medium text-sky-500 dark:text-sky-400">
                                            <?php echo e($dispositivo->vehiculoActual()->placa); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left text-slate-800 dark:text-gray-300 text-sm">
                                        <?php echo e($dispositivo->user ? $dispositivo->user->name : ''); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left text-slate-800 dark:text-gray-300 text-sm">
                                        <?php echo e($dispositivo->created_at->format('d-m-Y h:m')); ?>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="javascript: void(0)"
                                                            wire:click.prevent='openModalEdit(<?php echo e($dispositivo->id); ?>)'
                                                    ...
                                                    <li>
                                                        <a href="javascript: void(0)"
                                                            wire:click.prevent="verInfoDispositivo(<?php echo e($dispositivo); ?>) "class="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center px-4 py-2 text-sm font-normal"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivos->count() < 1): ?>
                            <tr>
                                <td colspan="8"
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'showModalNoRegistrados','title' => '','width' => '7xl','blur' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($dispositivosNoRegistrados) > 0): ?>
            ...
            <div
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->modelosFota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modeloInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                        ...
                        <button wire:click="seleccionarPorModelo('<?php echo e($modeloInfo['modelo']); ?>')"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($todosSeleccionados): ?>
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
                                </svg>
                            <?php elseif($algunoSeleccionado): ?>
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" />
                                </svg>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span class="font-bold"><?php echo e($modeloInfo['modelo']); ?></span>
                            <span
                                class="<?php echo e($todosSeleccionados ? 'bg-white/20' : 'bg-blue-100 dark:bg-blue-800/50'); ?> px-2 py-0.5 rounded-full text-xs font-bold">
                                <?php echo e($modeloInfo['count']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'modeloSeleccionado','placeholder' => 'Selecciona un modelo TELTONIKA','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->modelosTeltonika),'option-label' => 'modelo','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'guardarDispositivosSeleccionados','spinner' => 'guardarDispositivosSeleccionados','primary' => true,'icon' => 'check','label' => 'Guardar Seleccionados ('.e(count($dispositivosSeleccionados)).')']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                ...
                <?php echo e(json_encode($dispositivosSeleccionados)); ?>

                <?php echo e($modeloSeleccionado); ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($dispositivosSeleccionados) > 0): ?>
                    <div class="mt-3 flex items-center gap-2">
                        ...
                        <p class="text-xs font-medium text-indigo-600 dark:text-indigo-400">
                            <?php echo e(count($dispositivosSeleccionados)); ?> dispositivo(s) seleccionado(s)
                        </p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-900 dark:text-blue-100">
                            <?php echo e(number_format($totalFotaWeb)); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-900 dark:text-green-100">
                            <?php echo e(number_format($totalLocal)); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-900 dark:text-purple-100">
                            <?php echo e(number_format(count($dispositivosNoRegistrados))); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mb-4 flex justify-between items-center">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">
                        Mostrando <span
                            class="font-bold text-purple-600 dark:text-purple-400"><?php echo e(count($dispositivosNoRegistrados)); ?></span>
                        dispositivos
                    </p>
                </div>
                <?php if (isset($component)) { $__componentOriginalf04362c37f55b087f96f1c4fb07d5ce1 = $component; } ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'exportarNoRegistrados','emerald' => true,'label' => 'Exportar CSV','icon' => 'arrow-down-tray','sm' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="overflow-x-auto max-h-125 border border-gray-200 dark:border-gray-700 rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dispositivosNoRegistrados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispositivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-purple-50 dark:hover:bg-purple-900/10 transition-all duration-200"
                                <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('no-reg-{{ $dispositivo[\'imei\'] }}', get_defined_vars()); ?>wire:key="no-reg-<?php echo e($dispositivo['imei']); ?>">
                                <td class="px-4 py-3 text-center">
                                    <input type="checkbox" value="<?php echo e($dispositivo['imei']); ?>"
...
<?php endif; ?>
<?php $component->withAttributes(['rounded' => true,'blue' => true,'label' => ''.e($dispositivo['modelo']).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300 max-w-xs truncate">
                                    <?php echo e($dispositivo['descripcion'] ?: '-'); ?>

                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                                    <?php echo e($dispositivo['company_name']); ?>

                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivo['seen_at']): ?>
                                        <?php echo e(\Carbon\Carbon::parse($dispositivo['seen_at'])->format('d/m/Y H:i')); ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivo['activity_status'] === 'Active'): ?>
                                        <?php if (isset($component)) { $__componentOriginalb3b4efb7fe41ab882e85629f7bd48655 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb3b4efb7fe41ab882e85629f7bd48655 = $attributes; } ?>
<?php $component = WireUi\Components\Badge\Base::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form.badge'); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Badge\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['rounded' => true,'positive' => true,'label' => ''.e($dispositivo['activity_status']).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Badge\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['rounded' => true,'secondary' => true,'label' => ''.e($dispositivo['activity_status']).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['flat' => true,'label' => 'Cerrar','wire:click' => 'cerrarModalNoRegistrados']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/dispositivos/dispositivos-index.blade.php ENDPATH**/ ?>