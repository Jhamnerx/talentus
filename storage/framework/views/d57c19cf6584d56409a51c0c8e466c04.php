<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear-mantenimientos-vehiculos')): ?>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Export button -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('exportar-mantenimientos-vehiculos')): ?>
                <div class="relative inline-flex">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-slate-200 dark:border-gray-700 mb-8">
        <header class="px-5 py-4 border-b border-slate-200 dark:border-gray-700">
            <h2 class="font-semibold text-slate-800 dark:text-slate-100">Mantenimientos # <span
                    class="text-slate-400 dark:text-gray-500 font-medium"><?php echo e($mantenimientos->total()); ?></span>
            </h2>
        </header>
        <div>
                ...
                <table class="table-auto w-full">
                    ...
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Fecha de Programación</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['editar-mantenimientos-vehiculos', 'eliminar-mantenimientos-vehiculos',
                    ...
                    <tbody class="text-sm divide-y divide-slate-200 dark:divide-gray-700">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mantenimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mantenimiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('', get_defined_vars()); ?>wire:key='mant-<?php echo e($mantenimiento->id); ?>'>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-blue-500"><?php echo e($mantenimiento->numero); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 dark:text-gray-200">
                                        <?php echo e($mantenimiento->vehiculo->placa); ?>

                                    </div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-sky-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mantenimiento->vehiculo->cliente): ?>
                                            <?php echo e($mantenimiento->vehiculo->cliente->razon_social); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mantenimiento->vehiculo->cliente): ?>
                                        <div class="font-sm text-slate-900 dark:text-gray-400">
                                            <p class="text-xs">
                                                <?php echo e($mantenimiento->vehiculo->cliente->numero_documento); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 ">
                                    <div class="font-medium text-slate-800 dark:text-gray-200">
                                        <?php echo e($mantenimiento->detalle_trabajo); ?>

                                    </div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 dark:text-gray-200">
                                        <?php echo e($mantenimiento->fecha_hora_mantenimiento->format('d-m-Y')); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div
                                        class="inline-flex font-medium bg-<?php echo e($mantenimiento->estado->color()); ?>-100 text-<?php echo e($mantenimiento->estado->color()); ?>-600 rounded-full text-center px-2.5 py-0.5">
                                        <?php echo e($mantenimiento->estado->name); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 dark:text-gray-200">
                                        <?php echo e($mantenimiento->nota); ?></div>
                                </td>

                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 dark:text-gray-200">
                                        <?php echo e($mantenimiento->user->name); ?></div>
                                </td>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="m-1.5">
                                        ...
                                        <a target="_blank"
                                            href="<?php echo e(route('admin.pdf.mantenimiento', $mantenimiento)); ?>">
                                            <button type="button"
                                        ...
                                        <div class="relative inline-flex" x-data="{ open: false }">
                                            <div class="relative inline-block h-full text-left">
                                                ...
                                                <div class="origin-top-right  z-10 absolute transform  -translate-x-3/4  top-full left-0 min-w-36 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 py-1.5 rounded shadow-lg overflow-hidden mt-1  ring-1 ring-black ring-opacity-5 dark:ring-gray-700 divide-y divide-gray-100 dark:divide-gray-700 focus:outline-none"
                                                    ...
                                                    <ul>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-mantenimientos-vehiculos')): ?>
                                                            <li>
                                                                <a href="javascript: void(0)"
                                                                    wire:click.prevent='openModalEdit(<?php echo e($mantenimiento->id); ?>)'
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-mantenimientos-vehiculos')): ?>
                                                            <li>
                                                                <a href="javascript: void(0)"
                                                                    wire:click.prevent='openModalDelete(<?php echo e($mantenimiento->id); ?>)'
                                                                    class="text-gray-700 dark:text-gray-300 group flex items-center px-4 py-2 text-sm font-normal hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                    role="menuitem" tabindex="-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                        viewBox="0 0 24 24" stroke="currentColor"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('task-mantenimientos-vehiculos')): ?>
                                                            <li @click="open = false">
                                                                <a href="javascript: void(0)"
                                                                    wire:click.prevent="createTask(<?php echo e($mantenimiento->id); ?>)"
                                                                    class="text-gray-700 dark:text-gray-300 group flex items-center px-4 py-2 text-sm font-normal hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                    role="menuitem" tabindex="-1">
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mark-mantenimientos-vehiculos')): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mantenimiento->estado->name == 'COMPLETADA'): ?>
                                                                <li>
                                                                    <a href="javascript: void(0)"
                                                                        wire:click.prevent="markAs(<?php echo e($mantenimiento->id); ?>, 'CANCELADO')"
                                                                        class="text-gray-700 dark:text-gray-300 group flex items-center px-4 py-2 text-sm font-normal hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                        role="menuitem" tabindex="-1">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                            viewBox="0 0 24 24" stroke="currentColor"
                                                            ...
                                                            <?php else: ?>
                                                                <li>
                                                                    <a href="javascript: void(0)"
                                                                        wire:click.prevent="markAs(<?php echo e($mantenimiento->id); ?>, 'COMPLETADA')"
                                                                        class="text-gray-700 dark:text-gray-300 group flex items-center px-4 py-2 text-sm font-normal hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                        role="menuitem" tabindex="-1">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                            viewBox="0 0 24 24" stroke="currentColor"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mantenimientos->count() < 1): ?>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/vehiculos/mantenimiento/index.blade.php ENDPATH**/ ?>