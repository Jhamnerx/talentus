<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Certificados Antifatiga</h1>
        </div>
                            ...
                            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('', get_defined_vars()); ?>wire:key='certv-<?php echo e($certificado->id); ?>'>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-sky-500">
                                        ...
                                        <?php echo e(str_pad($certificado->id, 5, '0', STR_PAD_LEFT)); ?>


                                    </div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div><?php echo e($certificado->fecha_emision); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1">
                                        <a target="_blank"
                                            href="<?php echo e(route('admin.pdf.antifatiga', ['certificado' => $certificado, 'vehiculo' => $certificado->vehiculo])); ?>">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 truncate"
                                        title="<?php echo e($certificado->cliente['razon_social']); ?>">
                                        <?php echo e($certificado->cliente['razon_social']); ?>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/certificados/antifatiga/index.blade.php ENDPATH**/ ?>