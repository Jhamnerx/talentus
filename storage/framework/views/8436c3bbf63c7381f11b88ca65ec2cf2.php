            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                ...
                <div class="px-5 py-3 border-b border-slate-200">
                    <div class="flex justify-between items-center">
                        <div class="font-semibold text-slate-800">
                            ENVIAR CERTIFICADO VELOCIMETRO
                        </div>
                ...
                <div class="px-5 py-4">
                    <div class="text-sm">
                        <div class="font-medium text-slate-800 mb-3">
                            Enviar certificado a cliente 🙌</div>
                    </div>
                    <div class="space-y-3">
                        ...
                        <div class="mb-1 text-center w-full" wire:loading wire:target="sendCertificado">
                ...
                <div class="px-5 py-4 border-t border-slate-200" x-data="{ estado: <?php if ((object) ('disabled') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('disabled'->value()); ?>')<?php echo e('disabled'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('disabled'); ?>')<?php endif; ?>.live }">
                    <div class="flex flex-wrap justify-end space-x-2">
                        ...
                        <button wire:loading.attr="disabled" wire:target="sendCertificado" x-bind:disabled="estado"
                            class="btn-sm bg-indigo-500 hover:bg-indigo-600 disabled:bg-indigo-300 text-white"
                            wire:click="sendCertificado">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/certificados/velocimetros/send.blade.php ENDPATH**/ ?>