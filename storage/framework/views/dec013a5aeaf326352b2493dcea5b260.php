<div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-slate-200 dark:border-gray-600 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800 dark:text-gray-100">Ventas <span class="text-slate-400 dark:text-gray-400 font-medium"><?php echo e($ventas->total()); ?></span></h2>
    </header>
    <div>
            ...
            <table class="table-auto  w-full">
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('comprobantes-descargar-pdf')): ?>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-center">PDF</div>
                        </th>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('comprobantes-descargar-xml')): ?>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-slate-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="text-gray-900 dark:text-gray-100"><?php echo e($venta->fecha_hora_emision->format('d-m-Y / H:i:s')); ?>

                            </div>
                        </td>
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium <?php echo e($venta->envioResumen ? 'text-red-500' : 'text-sky-500'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($venta->tipo_comprobante_id):
                                case ('01'): ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->forma_pago == 'CREDITO'): ?>
                            <div>
                                    ...
                                    <div class="origin-top-right z-10 absolute top-full left-0 min-w-44 bg-white dark:bg-gray-800 border border-slate-300 dark:border-gray-600 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                                        ...
                                        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-gray-600">
                                            ...
                                            <div class="text-sm text-slate-600 dark:text-gray-300">
                                                Adelanto:
                                                <?php echo e($venta->divisa == 'USD' ? "$ " . $venta->adelanto : 'S/. ' .
                                                $venta->adelanto); ?>
                                        ...
                                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                            ...
                                            <tbody>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $venta->detalle_cuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <tr
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium text-slate-600 dark:text-slate-300">
                                <?php echo e($venta->divisa == 'PEN' ? 'S/ ' : '$'); ?> <?php echo e(number_format($venta->igv, 2)); ?>

                            </div>
                        </td>
                        
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <?php $saldo = round($venta->total - ($venta->payments_sum_monto ?? 0), 2); ?>
                            <div class="font-medium <?php echo e($saldo > 0 ? 'text-orange-500' : 'text-emerald-500'); ?>">
                                <?php echo e($venta->divisa == 'PEN' ? 'S/ ' : '$'); ?> <?php echo e(number_format($saldo, 2)); ?>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($venta->pago_estado):
                            case ('UNPAID'): ?>
                            <div
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->tipo_comprobante_id != '02'): ?>
                            <div class="space-x-1">

                                
                                <a target="_blank" href="<?php echo e(route('facturacion.ver.pdf', $venta)); ?>">
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            ...
                            <div class="space-x-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($venta->fe_estado):
...
<?php endif; ?>
                                ...
                                <button type="button" class="bg-white cursor-default">
                                    <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" height="511pt" version="1.1"
                                ...
                                <div x-data="{ open: false }" class="relative inline-block text-left">
                                    <div>
                                        <button class="inline-flex justify-center items-center grou text-sm font-medium"
                                            aria-haspopup="true" @click="open = !open" type="button"
                                            :aria-expanded="open">
                                            <div class="flex items-center truncate">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->fe_codigo_error == 'CDR'): ?>
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <div class="py-1 min-w-80" role="menu" aria-orientation="vertical"
                                            ...
                                            <div
                                                class="flex flex-nowrap px-4 py-2 text-sm <?php echo e($venta->fe_codigo_error == 'CDR' ? 'bg-orange-50' : ''); ?> hover:bg-gray-100 hover:text-gray-900">
                                                <div class="w-full">
                                                    <span>COMPROBANTE: </span>
                                                </div>
                                                <div class="w-full">
                                                    <x-form.badge <?php echo e($venta->fe_codigo_error == 'CDR' ? 'warning' : 'indigo'); ?> md label="<?php echo e($venta->serie_correlativo); ?>" />
                                                </div>
                                            </div>
...
<?php endif; ?>
<?php $component->withAttributes(['warning' => true,'md' => true,'label' => 'CDR PENDIENTE']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                            ...
                                            <div class="px-4 py-2 border-t border-slate-200">
                                                <button 
                                                    wire:click.prevent="consultarCdrPendiente(<?php echo e($venta->id); ?>)" 
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->tipo_comprobante_id != '02'): ?>
                            <div class="space-x-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->anulado == 'no'): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($venta->fe_estado):
...
<?php endif; ?>
                                ...
                                <button type="button" wire:click.prevent="consultarCdrPendiente(<?php echo e($venta->id); ?>)" 
...
<?php endif; ?>
                                            ...
                                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $venta->nota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $nota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <tr
                                                        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                        <th scope="row"
                                                            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'plus','label' => 'Volver a crear']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$venta->clase && $venta->fe_estado == '0'): ?>
                                    <?php if (isset($component)) { $__componentOriginal0e0c733fc4b7d84791e38fa8e7a5bb13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0e0c733fc4b7d84791e38fa8e7a5bb13 = $attributes; } ?>
<?php $component = WireUi\Components\Dropdown\Item::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown.item'); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Dropdown\Item::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-on:click' => '$dispatch(\'open-modal-consulta-cdr\')','icon' => 'magnifying-glass','label' => 'Consultar CDR Manual']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Dropdown\Item::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click.prevent' => 'consultarCdrPendiente('.e($venta->id).')','icon' => 'arrow-path','label' => 'Consultar y Actualizar CDR','separator' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Dropdown\Item::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'envelope-open','label' => 'Enviar a cliente']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->tipo_comprobante_id == '01'): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->anulado == 'no' && ($venta->estado_texto == 'ACEPTADA' || $venta->estado_texto == 'OBSERVACIONES:') &&
...
<?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->envioResumen && $venta->envioResumen->fe_estado != '1'): ?>
...
<?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($venta->anulado == 'si' && $venta->envioResumen == true &&
...
<?php $attributes = $attributes->except(\WireUi\Components\Dropdown\Header::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Pagos']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Dropdown\Item::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click.prevent' => 'abrirModalPagos('.e($venta->id).')','icon' => 'banknotes','label' => 'Ver Pagos']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ventas->count() < 1): ?> <tr>
...
</div><?php /**PATH C:\laragon2\www\talentus\resources\views/components/admin/facturacion/ventas-table.blade.php ENDPATH**/ ?>