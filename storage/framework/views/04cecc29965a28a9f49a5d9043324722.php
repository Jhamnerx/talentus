...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'ANULAR COMPROBANTE','wire:model.live' => 'openModal','align' => 'center']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Serie:','wire:model.live' => 'serie_ref','id' => 'serie','type' => 'text','readonly' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Correlativo:','wire:model.live' => 'correlativo_ref','id' => 'correlativo','type' => 'text','readonly' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Motivo de Anulación:','wire:model.live' => 'motivo','id' => 'motivo','type' => 'text']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['flat' => true,'label' => 'Cancelar','x-on:click' => 'close','wire:click.prevent' => 'closeModal']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Anular','wire:click.prevent' => 'anularComprobante','spinner' => 'anularComprobante']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/facturacion/ventas/anular-comprobante.blade.php ENDPATH**/ ?>