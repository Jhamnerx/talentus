...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Editar Producto','blur' => true,'wire:model.live' => 'modalEdit','align' => 'center']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'descripcion','wire:model' => 'descripcion','label' => 'Descripción:','placeholder' => 'Descripcion del producto']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'codigo','wire:model.live' => 'codigo','label' => 'Codigo:','placeholder' => 'Codigo del producto']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'unit_code','label' => 'Unidad:','wire:model.live' => 'unit_code','placeholder' => 'Selecciona una opcion','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('api.unit.index')),'option-label' => 'name','option-value' => 'codigo']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'stock','wire:model' => 'stock','label' => 'Stock:']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Divisa:','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['name' => 'SOLES', 'id' => 'PEN'], ['name' => 'DOLARES', 'id' => 'USD']]),'option-label' => 'name','option-value' => 'id','wire:model.live' => 'divisa','clearable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'icon' => 'currency-dollar']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tipo === 'servicio'): ?>
            <div class="col-span-12">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($yaExisteServicioCobro && !$es_servicio_cobro): ?>
                    <div
...
<?php $attributes = $attributes->except(\WireUi\Components\Switcher\Checkbox::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'es_servicio_cobro','name' => 'es_servicio_cobro','md' => true,'left-label' => '¿Servicio para Facturación de Cobros?','wire:model' => 'es_servicio_cobro','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($yaExisteServicioCobro && !$es_servicio_cobro)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Switcher\Checkbox::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'afecto_icbper','md' => true,'left-label' => 'Afecto icbper?','wire:model' => 'afecto_icbper']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        $(document).ready(function() {
            ...
            imagenEdit.on('addfile', (error, file) => {
                ...
                reader.onloadend = () => {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('file_name', file.file.name);
            ...
            imagenEdit.on('removefile', (error, file) => {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('file_name', null);
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/productos/edit-modal.blade.php ENDPATH**/ ?>