<div class="m-1.5 flex">
    ...
    <div x-data="{ modalSuspend: <?php if ((object) ('modalSuspend') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('modalSuspend'->value()); ?>')<?php echo e('modalSuspend'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('modalSuspend'); ?>')<?php endif; ?>.live }">
        <!-- Modal backdrop -->
            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                ...
                <div class="p-5 flex space-x-4">
                    ...
                    <div>
                        <!-- Modal header -->
                        <div class="mb-2">
                            <div class="text-lg font-semibold text-slate-800">Suspender Vehículo</div>

                        </div>
                        <!-- Modal content -->
                        <div class="text-sm mb-10">
                            <div class="space-y-2">
                                <p> Estas seguro de suspender el Vehiculo?. se guardara la informacion requerida para
                                    volver activar </p>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehiculo): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehiculo->dispositivos): ?>
                                <div class="mb-2">
...
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/vehiculos/suspend.blade.php ENDPATH**/ ?>