...
<?php endif; ?>
<?php $component->withAttributes(['required' => true,'wire:model.live' => 'selected.producto']); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Textarea::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['required' => true,'wire:model.live' => 'selected.descripcion']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['required' => true,'wire:model.live' => 'selected.cantidad','min' => '1','step' => '1','placeholder' => '45']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => '100.00','wire:model.live' => 'selected.precio']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('item-{{ $clave }}', get_defined_vars()); ?>wire:key="item-<?php echo e($clave); ?>" class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
...
<?php $attributes = $attributes->except(\WireUi\Components\TextField\Textarea::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['required' => true,'wire:model.live' => 'items.'.e($clave).'.producto']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                ...
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div class="font-normal text-center text-gray-800 dark:text-gray-200">
                        <?php echo e($items[$clave]['precio']); ?>

                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('items.' . $clave . '.precio')): ?>
                    <p class="mt-2  text-pink-600 text-sm">
                        <?php echo e($errors->first('items.' . $clave . '.precio')); ?>
...
</div><?php /**PATH C:\laragon2\www\talentus\resources\views/components/admin/ventas/tabla-detalle-venta.blade.php ENDPATH**/ ?>