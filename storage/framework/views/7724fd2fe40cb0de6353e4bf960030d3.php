...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Nueva Orden de Trabajo','wire:model.live' => 'modalSave','max-width' => '2xl']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tipo de Orden *','wire:model.live' => 'work_order_type_id','placeholder' => 'Seleccionar tipo','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tipos),'option-label' => 'nombre','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['autocomplete' => 'off','label' => 'Vehículo *','wire:model.live' => 'vehiculo_id','placeholder' => 'Buscar por placa','async-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('api.vehiculos.index')),'option-label' => 'placa','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Cliente *','wire:model' => 'cliente_nombre','disabled' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Técnico Asignado *','wire:model' => 'tecnico_id','placeholder' => 'Seleccionar técnico','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tecnicos),'option-label' => 'name','option-value' => 'id']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha Programada *','wire:model.live' => 'fecha_programada','parse-format' => 'YYYY-MM-DD HH:mm','display-format' => 'DD-MM-YYYY HH:mm','clearable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tipoRequiereMantenimiento): ?>
            <div
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$vehiculo_id): ?>
                ...
                <?php elseif($mantenimientosPendientes->isEmpty()): ?>
                    <p class="text-xs text-amber-600 dark:text-amber-400/80">
...
<?php $attributes = $attributes->except(\WireUi\Components\Select\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Vincular con Notificación de Mantenimiento','wire:model' => 'mantenimiento_id','placeholder' => 'Seleccionar mantenimiento programado (opcional)','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mantenimientosPendientes),'option-label' => 'label','option-value' => 'id','clearable' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Observaciones Iniciales','wire:model' => 'observaciones_inicial','placeholder' => 'Información adicional...','rows' => '3']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Crear Orden','wire:click' => 'save','spinner' => 'save']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/work-orders/create-modal.blade.php ENDPATH**/ ?>