            ...
            <ul class="flex flex-wrap -m-1">
                <li class="m-1">
                    <button
                        ...
                        <span class="ml-1 text-indigo-200"><?php echo e($certificados->total()); ?></span></button>
                </li>
            </ul>
        </div>
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">Certificados <span
                    class="text-slate-400 font-medium"><?php echo e($certificados->total()); ?></span>
            </h2>
        </header>
        <div>
            ...
            <div class="overflow-x-auto min-h-screen">
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-slate-200">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $certificados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-sky-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$certificado->codigo == null): ?>
                                            <?php echo e($certificado->codigo); ?>

                                        <?php else: ?>
                                            <?php echo e($certificado->ciudades->prefijo . '-' . $certificado->numero); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1">
                                        <a target="_blank"
                                            href="<?php echo e(route('admin.pdf.certificados', ['certificado' => $certificado, 'vehiculo' => $certificado->vehiculo])); ?>">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800">
                                        <?php echo e($certificado->vehiculo->placa); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3">
                                    <div class="font-medium text-slate-800">
                                        <?php echo e($certificado->vehiculo->cliente->razon_social); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800">
                                        <?php
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dispositivoPrincipal && $dispositivoPrincipal->dispositivo && $dispositivoPrincipal->dispositivo->modelo): ?>
                                            <?php echo e($dispositivoPrincipal->dispositivo->modelo->modelo); ?>

                                            <br><small>(IMEI: <?php echo e($dispositivoPrincipal->imei); ?>)</small>
                                        <?php else: ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800">
                                        <?php echo e($certificado->fin_cobertura->format('d-m-Y')); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div><?php echo e($certificado->fecha_instalacion->format('d-m-Y')); ?></div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    ...
                                    <div class="relative" x-data="{ open: false }" @mouseenter="open = true"
                                        ...
                                        <button class="btn border-slate-200 hover:border-slate-300 text-slate-600"
                                            ...
                                            <span class="mr-2">Accesorios
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$certificado->accesorios->isEmpty()): ?>
                                                    (<?php echo e($certificado->accesorios->count()); ?>)
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    ...
                                                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                                        <table
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php else: ?>
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $certificado->accesorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $accesorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                                        <tr
                                                                            ...
                                                                            <td class="px-6 py-4">
                                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($accesorio) && isset($accesorio['nombre']) && $accesorio['nombre'] === 'BUZZER'): ?>
                                                                                    <?php echo e($accesorio['nombre']); ?>

                                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($accesorio['detalle'])): ?>
                                                                                        <br><small
                                                                                            class="text-gray-500">(<?php echo e($accesorio['detalle']); ?>)</small>
                                                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                                <?php else: ?>
                                                                                    <?php echo e(is_array($accesorio) ? $accesorio['nombre'] : $accesorio); ?>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 w-48">
                                    <div>
                                        <div class="m-3 w-48">
                                            <div class="flex items-center mt-2" x-data="{ checked: <?php echo e($certificado->sello ? 'true' : 'false'); ?> }">
                                                <span class="text-sm mr-3">Sello: </span>
                                                <div class="form-switch">
                                                    <input wire:click="toggleSello(<?php echo e($certificado->id); ?>)"
                                                        type="checkbox" id="switch-s<?php echo e($certificado->id); ?>"
                                                        class="sr-only" x-model="checked" />
                                                    <label class="bg-slate-400" for="switch-s<?php echo e($certificado->id); ?>">
                                            ...
                                            <div class="flex items-center mt-2" x-data="{ checked: <?php echo e($certificado->fondo ? 'true' : 'false'); ?> }">
                                                <span class="text-sm mr-3">Fondo: </span>
                                                <div class="form-switch">
                                                    <input wire:click="toggleFondo(<?php echo e($certificado->id); ?>)"
                                                        type="checkbox" id="switch-f<?php echo e($certificado->id); ?>"
                                                        class="sr-only" x-model="checked" />
                                                    <label class="bg-slate-400" for="switch-f<?php echo e($certificado->id); ?>">
                                                        <span class="bg-white shadow-sm" aria-hidden="true"></span>
                                                        <span class="sr-only">Estado</span>
                                                    </label>
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <a href="javascript: void(0)"
                                                            wire:click.prevent="openModalEdit(<?php echo e($certificado->id); ?>)"
                                                    ...
                                                    <li>
                                                        ...
                                                        <button type="button"
                                                            wire:click.prevent="openModalDelete(<?php echo e($certificado->id); ?>)"
                                                            class="text-gray-700 group flex items-center px-4 py-2 text-sm font-normal">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke="currentColor"
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('admin.certificados.gps.show', $certificado)); ?>"
                                                            class="text-gray-700 group flex items-center px-4 py-2 text-sm font-normal"
                                                    ...
                                                    <li>
                                                        <a wire:click.prevent="cambiarEstado('<?php echo e($certificado->id); ?>', 'estado', '<?php echo e($certificado->estado ? 0 : 1); ?>')"
                                                            class="text-gray-700 group hover:cursor-pointer flex items-center px-4 py-2 text-sm font-normal"
                                                            disabled="false" id="headlessui-menu-item-29"
                                                            role="menuitem" tabindex="-1">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$certificado->estado): ?>
                                                    ...
                                                    <li>
                                                        <a href="javascript: void(0)"
                                                            wire:click="modalOpenSend(<?php echo e($certificado->id); ?>)"
                                                            class="text-gray-700 group flex items-center px-4 py-2 text-sm font-normal"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certificados->count() < 1): ?>
                            <tr>
                                <td colspan="9"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon2\www\talentus\resources\views/livewire/admin/certificados/gps/certificados-gps-index.blade.php ENDPATH**/ ?>