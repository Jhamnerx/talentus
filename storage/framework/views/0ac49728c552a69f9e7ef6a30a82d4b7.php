...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($multiple): ?>
        ...
        >
            <template x-for="(date, index) in selectedDatesDisplay" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('date', get_defined_vars()); ?>wire:key="date">
                <button
                    class="
...
<?php unset($__componentOriginal511d4862ff04963c3c16115c05a86a9d); ?>
<?php endif; ?>
<?php /**PATH C:\laragon2\www\talentus\vendor\wireui\wireui\src/Components/DatetimePicker/views/picker.blade.php ENDPATH**/ ?>