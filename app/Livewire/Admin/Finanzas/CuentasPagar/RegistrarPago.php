...
class RegistrarPago extends Component
{
    ...
    #[On('registrar-pago-proveedor')]
    public function open($id)
    {
        $this->cuenta_id = $id;
        $this->cuenta = AccountPayable::findOrFail($id);
    ...
    public function registrar()
    {
        ...
        $this->dispatch('render')->to(\App\Livewire\Admin\Finanzas\CuentasPagar\Index::class);
        $this->closeModal();
    }
    ...
    {
        return view('livewire.admin.finanzas.cuentas-pagar.registrar-pago');
    }
}
