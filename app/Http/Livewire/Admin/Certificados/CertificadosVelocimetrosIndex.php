...
class CertificadosVelocimetrosIndex extends Component
{
    public $search;
    public $from = '';
    public $to = '';
    public function render()
    {
        ...
        return view('livewire.admin.certificados.certificados-velocimetros-index', compact('certificados', 'total'));
    }
