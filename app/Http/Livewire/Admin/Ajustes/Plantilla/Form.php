...
class Form extends Component
{
    ...
    public function save()
    {
        ...
        $this->plantilla->save();
        $this->dispatchBrowserEvent('save', ['mensaje' => 'Datos Actualizados Correctamente.']);
    }
    ...
    public function saveSeries()
    {
        ...
        $this->plantilla->save();
        $this->dispatchBrowserEvent('save', ['mensaje' => 'Series Actualizadas Correctamente.']);
    }
    ...
    public function saveSunat()
    {
        ...
        $this->plantilla->save();
        $this->dispatchBrowserEvent('save', ['mensaje' => 'Datos de SUNAT Actualizados Correctamente.']);
    }
}
