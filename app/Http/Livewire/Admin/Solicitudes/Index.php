...
class Index extends Component
{
    ...
    public function markComplete(Solicitudes $solicitud)
    {
        ...
        $solicitud->save();
        $this->dispatchBrowserEvent('update-solicitud', ['titulo' => 'SOLICITUD COMPLETADA', 'message' => 'Se marco como completada la solicitud',  'numero' => $solicitud->numero, 'color' => '#34d399', 'progressBarColor' => 'rgb(255,255,255)']);
        $this->render();
    }
}
