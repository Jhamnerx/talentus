# Placa de vehiculo - Documentación
...
```
curl --request GET \
  --url https://api.factiliza.com/v1/placa/info/{placa} \
...
[Consulta CPE](/api-consulta/endpoint/sunat-cpe)[SOAT de vehiculo](/api-consulta/endpoint/soat)
