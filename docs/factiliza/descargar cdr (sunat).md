# Descargar CDR (SUNAT) - Documentación
...
```
curl --request GET \
  --url https://api.factiliza.com/v1/sunat/cdr/{numRuc}-{tipoDocumento}-{numSerieComprobante}-{numDocumentoComprobante} \
  --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzODU0MyIsImh0dHA6Ly9zY2hlbWFzLm1pY3Jvc29mdC5jb20vd3MvMjAwOC8wNi9pZGVudGl0eS9jbGFpbXMvcm9sZSI6ImNvbnN1bHRvciJ9.XYXTELsur5uJjv3ZbX-f3Tt_bFhr7RHUsM4xFrioMVc'
```
...
Descarga el CDR de cualquier boleta o factura enviada a SUNAT, sin importar quien la emitió
...
[Descargar PDF (SUNAT)](/api-consulta/endpoint/sunat-pdf)[Descargar Guia JSON (SUNAT)](/api-consulta/endpoint/sunat-guia)
