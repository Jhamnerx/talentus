# Carnet de extranjeria - Documentación
...
```
curl --request GET \
  --url https://api.factiliza.com/v1/cee/info/{cee} \
...
[RUC - Representante](/api-consulta/endpoint/ruc-representante)[Integra Facturador PRO](/api-consulta/facturador-pro)
