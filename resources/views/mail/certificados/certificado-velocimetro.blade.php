            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ Storage::url('mail/certificados/images/image-5.png') }}"
                                                                            alt="Logo" title="Logo"
                    ...
                    <div class="u-row-container"
                        style="padding: 0px;background-image: url({{ Storage::url('mail/certificados/images/image-4.jpeg') }});background-repeat: no-repeat;background-position: center top;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align"
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Lato',sans-serif; font-size: 36px;">
                                                                <strong>CERTIFICADO DE VELOCIMETRO </strong>
                                                                <br>
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 286px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
                                                            ...
                                                            <h1 class="v-text-align"
                                                                ...
                                                                registro de certificado de velocimetro
                                                            </h1>
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>
                                                                        <span
                                                                            ...
                                                                            Hola
                                                                            {{ $certificado->vehiculo->cliente->razon_social }}!</span>
                                                                    </strong>
                                                                    <br>
                                                                    <br>
                                                                    <br>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #9b9999; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <table height="0px" align="center" border="0"
                                                                ...
                                                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #e4e0e0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                <tbody>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #444444; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-family: Montserrat, sans-serif; font-size: 18px; line-height: 25.2px;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:38px 10px 0px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align"
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Lato',sans-serif; font-size: 28px;">
                                                                <strong>CONTROLA EL RECORRIDO</strong>
                                                            </h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align"
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Lato',sans-serif; font-size: 18px;">
                                                                Entre otras herramientas para tu flota*
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Calle
                                                                        Santa María Nº 209, Cajamarca. Perú</span></p>
                                                            </div>
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.facebook.com/TalentuTechnologyGPS"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ Storage::url('mail/certificados/images/image-2.png') }}"
                                                                                            alt="Facebook"
                                                                                            title="Facebook"
                                                                                            width="32"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.instagram.com/talentustechnology/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ Storage::url('mail/certificados/images/image-1.png') }}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
