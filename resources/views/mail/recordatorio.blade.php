        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:6px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #052c52;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #052c52;"><![endif]-->

                                <!--[if (mso)|(IE)]><td align="center" width="300" style="background-color: #052c52;width: 300px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                                    ...
                                    <div style="background-color: #052c52;height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ Storage::url('mail/notificacion/images/image-3.png') }}"
                                                                            alt="Image" title="Image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 28%;max-width: 78.4px;"
                                                                            width="78.4" />
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;"><strong><span
                                                                                ...
                                                                                RECORDATORIO - REPORTE VEHICULO
                                                                                {{ $recordatorio->reporte->vehiculos->placa }}
                                                                            </span>
                                                                        </strong>
                                                                    </span>
                                                                </p>
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            {{-- <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 2px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 18px; line-height: 25.2px;"><strong><span
                                                                                style="line-height: 25.2px; font-size: 18px;">Anastasia
                                                                                Charlotte</span></strong></span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; text-align: center;">
                                                                    <span
                                                                        style="font-size: 14px; line-height: 19.6px;">Account
                                                                        Manager</span>
                                                                </p>
                                                            </div>
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 50px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="{{ route('admin.vehiculos.reportes.show', $recordatorio->reporte->id) }}"
                                                                    target="_blank"
                                ...
                                <div class="u-col u-col-50"
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_7" style="font-family:'Open Sans',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:23px 60px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                ...
                                <div class="u-col u-col-50"
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.instagram.com/talentustechnology/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ Storage::url('mail/notificacion/images/image-2.png') }}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.facebook.com/TalentuTechnologyGPS"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ Storage::url('mail/notificacion/images/image-1.png') }}"
                                                                                            alt="Facebook"
                                                                                            title="Facebook"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                            ...
                                            <table id="u_content_text_8" style="font-family:'Open Sans',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; text-align: center;">
                                                                    <span
                                                                        style="font-size: 14px; line-height: 19.6px; color: #ffffff;">soporte@talentustechnology.com</span>
                                                                </p>
                                                            </div>
