        ...
        * {
        ...
        @media (max-width: 480px) {
            #u_row_5 .v-row-background-color {
                background-color: #3ab2de !important;
            }
            ...
            #u_content_image_1 .v-container-padding-padding {
                padding: 9px 10px 74px 0px !important;
            }
            ...
            #u_content_text_3 .v-container-padding-padding {
                padding: 5px 23px 15px !important;
            }
        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div id="u_row_5" class="u-row-container v-row-background-image--outer v-row-background-color"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:17px 10px 7px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                ...
                                <div class="u-col u-col-69p83"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_menu_1" style="font-family:'Montserrat',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="menu" style="text-align:center">
                                                                ...
                                                                <!--[if (mso)|(IE)]><td style="padding:15px 15px 13px"><![endif]-->

                                                                <a href="https://www.talentustechnology.com/"
                                                                    target="_blank"
                                                                    style="padding:15px 15px 13px;display:inline-block;color:#ffffff;font-family:arial,helvetica,sans-serif;font-size:14px;text-decoration:none"
                                                                ...
                                                                <a href="https://www.talentustechnology.com/contacto"
                                                                    target="_blank"
                                                                    style="padding:15px 15px 13px;display:inline-block;color:#ffffff;font-family:arial,helvetica,sans-serif;font-size:14px;text-decoration:none"
                                                                    class="v-padding v-font-size">
                                                                    Contactar
                    ...
                    <div id="u_row_1" class="u-row-container v-row-background-image--outer v-row-background-color"
                        style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                            <div class="v-row-background-image--inner"
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_1"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:44px 10px 0px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #ffffff; line-height: 100%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Pacifico',cursive; font-size: 45px;">
                                                                Feliz Cumpleaños
                                                            </h1>
                                            ...
                                            <table id="u_content_heading_2"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:22px 10px 6px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                            ...
                                            <table id="u_content_image_1" style="font-family:'Montserrat',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:35px 0px 181px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                        ...
                                        <div
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #252525; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 26px;">
                                                                ¡Ten un maravilloso cumpleaños!
                                                            </h1>
                                            ...
                                            <table id="u_content_text_1" style="font-family:'Montserrat',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 70px 30px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align"
                                                                style="color: #3f3f3f; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">Hoy es
                                                                    el cumpleaños de la persona que está esparciendo
                                                                    alegría y positivismo por todas partes. ¡Que tu
                                                                    cumpleaños y tu vida sean tan maravillosos como tú!
                                                                </p>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_4"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:50px 10px 0px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #252525; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">Haz tu
                                                                    viaje maravilloso.</p>
                                                            </div>
                                            ...
                                            <table id="u_content_button_1"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 50px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <a href="https://www.talentustechnology.com"
                                                                    ...
                                                                    <span class="v-padding"
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><strong><span
                                                                                ...
                                                                                tus beneficios</span></strong></span>
                                                                </a>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_image_2" style="font-family:'Montserrat',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:47px 10px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_5"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 0px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 16px;">
                                            ...
                                            <table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 25px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p
                                                                    ...
                                                                    Telefonos:  977 794 338
                                                                    944 299 794</p>
                                                                <p style="font-size: 14px; line-height: 140%;">Email:
                                                                    <span
                                                                        style="font-size: 10px; line-height: 14px;">gerencia@talentustecnology.com</span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Calle
                                                                    Santa María Nº 209, Cajamarca.</p>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_5" style="font-family:'Montserrat',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align"
                                                                style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">¿Ya no
                                                                    quieres recibir estos correos electrónicos? Darse de
                                                                    baja.</p>
                                                            </div>
