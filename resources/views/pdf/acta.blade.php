                ...
                <div>
                    <span>
                        ...
                        <b>{{ $acta->vehiculo->cliente
                            ...
                            existe' }}</b>
                        con DNI/RUC:
                        {{ $acta->vehiculo->cliente ? $acta->vehiculo->cliente->numero_documento : 'REGISTRAR CLIENTE'
                        }}, ha
                        adquirido un equipo
                        GPS,
            ...
            <div class="descripcion">
                <table class="tabla">
                    <tr>
                        ...
                        <td height="20">:
                            {{ $acta->fecha_instalacion ? $acta->fecha_instalacion->format('d-m-Y') : 'completar dato'
                            }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="20">:
                            {{ $acta->vehiculo->dispositivos ? $acta->vehiculo->dispositivos->modelo->modelo :
                            '##COMPLETAR DATOS' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="20">:
                            {{ $acta->vehiculo->dispositivos ? $acta->vehiculo->dispositivos->modelo->certificado :
                            '##COMPLETAR DATOS' }}
                        </td>
                    </tr>
