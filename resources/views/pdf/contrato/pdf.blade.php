...
<body>
    ...
    <div class="contrato">
            ...
            <div>
                ...
                <p>
                    ...
                    representada por su <b>Gerente General
                        ...
                        $contrato->cliente->contactos()->gerente(1)->first()->nombre: '"agregar"' }}</b>,
                    identificado con DNI
                    N°
                    <b>{{ $contrato->cliente->contactos()->gerente(1)->first()?
                        $contrato->cliente->contactos()->gerente(1)->first()->numero_documento: '"agregar"' }}</b>,
                    con correo electrónico
                    <b>{{ $contrato->cliente->contactos()->gerente(1)->first()?
                        $contrato->cliente->contactos()->gerente(1)->first()->email: '"agregar"' }}</b>,
                    a
        ...
        <section>
            @if ($contrato->detalle->count() <= 5) <section class="center-text padding-1">
                <div>
                    <div>
                        <table class="tabla">
        ...
        @if ($contrato->detalle->count() > 5 && $contrato->detalle->count() <= 10) <div class="row">
    ...
    @if ($contrato->detalle->count() > 10 && $contrato->detalle->count() <= 20) <div class="row">
        <div class="columns medium-6 tabla-1">
        ...
        @if ($contrato->detalle->count() > 20 && $contrato->detalle->count() <= 30) <div class="row">
            ...
            <div class="">
                <div class="medium-12 columns">
                    ...
                    <p>
                        ...
                        cláusula
                        que
                        antecede, es en una cobertura de rastreo solamente en el Territorio Peruano durante las 24 horas
                        del
                        día
                        los 365 días del año, con personal debidamente capacitado y con sistemas que garantizan la
                        atención
                        de
                        todas las necesidades de&nbsp;<b>EL CLIENTE</b>. Para que se brinde el presente servicio, <b>EL
                            CLIENTE
                        </b>se obliga a comprar el equipo a <b>T Y T, </b>o de acuerdo al plazo del contrato, se obliga
                        a
                        alquilar el equipo; en el supuesto que <b>EL CLIENTE </b>ya tenga el equipo, <b>T Y T</b> sólo
                        realizará
                    ...
                    <p class="padding-4">
                        <b>2.2.- TALENTUS TECHNOLOGY E.I.R.L.</b>&nbsp;no se responsabiliza por los eventuales cortes en
                        la
                        ...
                        inalámbrica de&nbsp;<b>T Y T </b>y/o por la falta de pago por parte de&nbsp;<b>EL CLIENTE</b>,
                        y/o
                        por
                        algún desperfecto técnico en los sistemas de energía que puede provocar un reinicio forzado en
                        los
                        servidores (cuyo reinició puede ocasionar la corrupción de datos en los discos duros que usamos
                        para
                    ...
                    <p>
                        ...
                        Monitoreo
                        y
                        Atención al Cliente con personal debidamente capacitado y con un sistema de alta disponibilidad
                        que
                        garantiza la recepción y atención de la información para realizar la localización y rastreo, así
                        como la
                        generación de reportes; así mismo declara que su número telefónico a efecto de comunicaciones es
                        el
            ...
            <div class="row">
                <div class="medium-12 columns">
                    ...
                    <p>
                        <b>3.1.-</b> En virtud del presente contrato, <b>EL CLIENTE</b> se obliga ante <b>EL LOCADOR</b>
                        a
                        pagar
                        en calidad de contraprestación la cantidad de S/ ___(x)___ (___(x)___ con 00/100 Soles), monto
                        que
                        no
                        que incluye IGV, de forma ……… y por adelantado, previa emisión de la factura correspondiente,
                        realizándose en la cuenta perteneciente a <b>T Y T</b> que les brinde oportunamente. El monto
                        indicado
                ...
                <div class="medium-12 columns">
                    ...
                    <p>
                        <b>5.1.- EL CLIENTE&nbsp;</b>se compromete a definir y comunicar a&nbsp;<b>TALENTUS TECHNOLOGY
                            E.I.R.L.</b>, la placa de la unidad, así como su nombre y/o razón social, y demás datos que
                        se
                        les
                        ...
                        de&nbsp;<b>TALENTUS
                            ...
                            TECHNOLOGY E.I.R.L.</b>&nbsp;quien cambie la clave previamente otorgada e informe al cliente
                        la
                    ...
                    <p>
                        ...
                        información posible acerca del incidente y siguiendo obligatoriamente todas las indicaciones que
                        se
                    ...
                    <p>
                        ...
                        contrario
                        este
                        incumplimiento, puede ser causal de resolución del presente contrato, independientemente de las
                        acciones
            ...
            <div class="row">
                <div class="medium-12 columns">
                            ...
                            <tbody class="tabla-border">
                                ...
                                <tr style="height: 76px;">
                                    ...
                                    <td>Reportes en formato Excel de las
                                        unidades vehiculares (siempre y cuando el usuario no pueda acceder desde una PC
                                        a la
                                        plataforma)</td>
                                    <td>2 horas</td>
                                </tr>
                    ...
                    <p>
                        <b> 5.5.- EL CLIENTE </b>se responsabiliza por cualquier concepto de multa en el ente regulador
                        Sutrán,
                    ...
                    <p>
                        ...
                        conocimiento
                        por
                        intermedio del presente documento que el equipo GPS tiene una vida útil aproximada no mayor a
                        tres
                        (03)
                        ...
                        del presente contrato (ver cláusula tercera y demás aplicables); motivo por el cual, <b>Talentus
                            Technology EIRL, </b>no se responsabiliza de ser el caso, de reportes errados emitidos por
                        el
                        GPS
                    ...
                    <p>
                        <b>5.7.- CLIENTE</b> autoriza a <b>Talentus Technology EIRL</b> a recolectar y procesar datos
                        personales
                        (ruc, razón social, fecha de nacimiento, correos, teléfonos y alguna otra información que sea
                        necesaria
                        para brindar un óptimo servicio), garantizando la confidencialidad, integridad y disponibilidad
                        de
                        la
                    ...
                    <ul>
                        ...
                        <li>
                            <span>Utilizarlos para fines administrativos en las diferentes actividades que realiza la
                                empresa y
                    ...
                    <p>
                        ...
                        actualización, revocatoria y supresión de sus datos personales, siempre que no exista un mandato
                        legal o
            ...
            <div class="row">
                <div class="medium-12 columns">
                    ...
                    <p><b>6.1.- TALENTUS TECHNOLOGY E.I.R.L.&nbsp;</b>no es una empresa de seguros por lo que no se le
                        ...
                        consecuencia
                        del
                        robo o secuestro, o inminente robo o secuestro de&nbsp;los vehículos, o cargas que transporten
                        (incluido
                    ...
                    <p>
                        ...
                        (deficiente o
                        aceptable) del servicio de comunicación inalámbrica que le brinda la empresa proveedora de la
                        señal
                        inalámbrica necesaria para la prestación del servicio brindado. <br>
                    </p>
                    <p>
                        <b>6.4.- EL CLIENTE</b>&nbsp;acepta que los referidos casos no constituyen incumplimiento por
                        parte
                    ...
                    <p>
                        <b>6.5.- TALENTUS TECHNOLOGY E.I.R.L.</b> no se responsabiliza por desperfectos técnicos en los
                        sistemas
                        de energía que puede provocar un reinicio forzado en los servidores y cuyo reinició puede
                        ocasionar
                        la corrupción de datos en los discos duros que usamos para almacenar la data de los reportes.
                        <br><b>
                    </p>
                    <p>
                        <b>6.6.- </b>Están comprendidos los casos de fuerza mayor y casos fortuitos, que pudieran darse
                        al
            ...
            <div class="row">
                <div class="medium-12 columns">
                    ...
                    <p>
                        <b>7.1.-</b> Para efectos que&nbsp;<b>TALENTUS TECHNOLOGY E.I.R.L.&nbsp;</b>brinde el servicio
                        objeto
                        del
            ...
            <div class="row">
                <div class="medium-12 columns">
                    ...
                    <p>
                        ...
                        vencimiento,
                        debido al incumplimiento de alguna obligación pactada o inherente al servicio de conformidad con
                        el
                        artículo 1371° del Código Civil.
                    </p>

                    <p>
                        <b>8.2.-</b> En caso&nbsp;<b>EL CLIENTE&nbsp;</b>desee resolver el presente contrato mientras
                        que
                        este
                        se
                        encuentre vigente, tendrá que enviar un correo (solicitando acuse de recepción) a
                        administracion@talentustechnology.com, indicando la baja del servicio el cual será atendido en
                        un
                        plazo
                    ...
                    <p>
                        ...
                        con una anticipación no menor a 30 días calendarios posteriores a la notificación de su decisión
                        de
                        resolver el presente contrato.
                    </p>

                    <p><b>8.4.-</b> En caso de incumplimiento de obligaciones, se puede requerir el normal desarrollo
                        del
                        ...
                        fuera de solicitar la indemnización correspondiente de acuerdo con el artículo 1428° del Código
                        Civil.
                    </p>
                    ...
                    <p>
                        ...
                        respectivo,
                        informando la decisión de resolver total o parcialmente el contrato. Si <b>EL CLIENTE</b> decide
                        dejar
                        sin efecto el contrato antes del vencimiento del primer año forzoso, deberá pagar a favor
                        de&nbsp;<b>TALENTUS TECHNOLOGY E.I.R.L.&nbsp;</b>una penalidad conforme lo establece el artículo
                        1341°
                        del Código Civil, correspondiente este igual al 50% del monto adeudado hasta la culminación del
                        contrato y adicionalmente el total del monto del valor del equipo GPS, en caso de que se haya
                        acordado
                        su pago durante un periodo de doce meses. Si&nbsp;<b>EL CLIENTE</b>&nbsp;incumple con el pago de
                        la
                        mensualidad del servicio contratado, <b>TALENTUS TECHNOLOGY E.I.R.L.</b> tiene la facultad de
                        suspender
                        el servicio de localización, rastreo, ubicación, control y supervisión satelital vehicular hasta
                        que
                        ...
                        comprobantes
                        de pago con la finalidad que otras entidades financieras puedan realizar el cobro respectivo,
                        por lo
                        tanto, mediante la suscripción del presente contrato, <b>EL CLIENTE </b>acepta lo mencionado
                        anteriormente. En caso de que el servicio haya sido suspendido por falta de pagos y no se pueda
                        realizar
            ...
            <div class="row padding-2">
                <div class="medium-12 columns">
                    ...
                    <p class=" padding-2"> Para la validez de todas las comunicaciones y notificaciones a las partes,
                        con
                        motivo de la
                        ejecución de
                        este contrato, ambas señalan como sus respectivos domicilios los indicados en la introducción de
                        este
                        documento. El cambio de cualquiera de las partes surtirá efectos desde la fecha de comunicación
                        de
                        dicho
            ...
            <div class="" style="padding-top: -20px">
                ...
                <div class="columns medium-6" style="position:relative; left: 23rem; top: -4rem">
                    <div class="sello">
                        @if ($contrato->sello)
