    ...
    <div class="xl:w-2/3 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6 w-full">
        <div class="border-b border-gray-200 pb-6">
            ...
            <h1 class="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-800 dark:text-white mt-2">
                DATOS CERTIFICADO CONSULTADO</h1>
        </div>
        <div class="py-4 border-b border-gray-200 flex items-center justify-between">
            <p class="text-base leading-4 text-gray-800 dark:text-gray-300">Codigo:</p>
            <div class="flex items-center justify-center">
                <p class="text-sm leading-none text-gray-600 dark:text-gray-300 mr-3">{{ $certificado->codigo }}</p>
        ...
        <div class="py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <div class="flex items-center justify-center">
                <p class="text-sm leading-none text-gray-600 dark:text-gray-300">{{ $certificado->vehiculo->placa }}</p>
        ...
        <div>
            ...
            <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Modelo Velocimetro:
                {{ $certificado->velocimetro_modelo }}
            </p>
            <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Codigo Único:
                {{ $certificado->unique_hash }}
            </p>
            <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Emitido: {{ $certificado->fecha }}</p>


        </div>
        <div>
            <p class="text-base leading-4 mt-4 text-red-600 dark:text-gray-300">El codigo único debe coincidir con
                el
