    ...
    @if ($certificado)
        <div class="xl:w-2/3 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6 w-full">
            ...
            <div class="py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <div class="flex items-center justify-center">
                    <p class="text-sm leading-none text-gray-600 ">{{ $certificado->vehiculo->placa }}</p>
            ...
            <div>
                ...
                <p class="text-base leading-4 mt-4 text-gray-600 ">Modelo Velocimetro:
                    {{ $certificado->velocimetro_modelo }}
                </p>
                <p class="text-base leading-4 mt-4 text-gray-600 ">Codigo Único:
                    {{ $certificado->unique_hash }}
                </p>
                <p class="text-base leading-4 mt-4 text-gray-600 ">Emitido: {{ $certificado->fecha }}</p>
