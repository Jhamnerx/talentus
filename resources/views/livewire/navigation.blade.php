<div class="h-full w-full">
    ...
    <nav role="navigation" class="bg-white shadow-xl lg:block xl:block hidden pb-1 z-20">
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-2 font-bold">Consulta Actas</span>
                                    </div>
                                </li>
                                <li class="xl:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-2 font-bold">Vehiculos</span>
                                    </div>
                                </li>
                                ...
                                <li
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        {{-- <p class="text-sm ml-2 cursor-pointer">{{auth()->user()->name}}</p> --}}
                ...
                <a href="{{route('web.home')}}"
                    ...
                    <div class="flex items-center">
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light-with-button-svg3.svg"
                            alt="logo" />
                        <h2 class="hidden sm:block text-base text-gray-700 font-bold leading-normal px-3">T&T SISTEMA
                        </h2>
                    </div>
                </a>
                <div class="flex">
                    ...
                    <div class="hidden xl:flex items-center">
                        <div class="relative md:mr-6 my-2">
                            <a href="{{route('admin.home')}}">
                                <button
                                    class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:text-indigo-700 focus:outline-none bg-gray-100 border-gray-300 border transition duration-150 ease-in-out hover:bg-gray-300 rounded text-gray-600 px-5 py-2 text-xs">
                                    ADMINISTRADOR
                                </button>
                            </a>
                        </div>
                        <div class="ml-6 relative z-30">
                            <button aria-label="dropdown"
                                class="focus:outline-none border-b-2 border-transparent focus:border-indigo-700   focus:text-indigo-700 text-gray-600 hover:text-indigo-700 flex items-center relative"
                                onclick="dropdownHandler(this)">
                                <ul
                                ...
                                <div>
                                    ...
                                    <a href="{{route('login')}}"
                                        class="text-talentus-200 border border-talentus-200 hover:bg-talentus-200 hover:text-white active:talentus-2000 font-bold uppercase px-8 py-1 rounded-full outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
    ...
    <nav>
        <div class="py-4 px-6 w-full flex xl:hidden mb-5 justify-between items-center bg-white fixed top-0 z-40">
            ...
            <div class="flex items-center">
                <div class="relative mr-6">
                    <a href="{{route('admin.home')}}">
                        <button
                            class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none bg-gray-100 border-gray-300 border transition duration-150 ease-in-out hover:bg-gray-300 rounded text-gray-600 px-5 py-2 text-xs">
                            ADMINISTRADOR
                        </button>
                    </a>
                </div>
                <button id="menu" aria-label="open menu"
                    ...
                    <img class="icon icon-tabler icon-tabler-menu-2"
                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light-with-button-svg10.svg" alt="menu" />
                </button>
            </div>
        </div>
        ...
        <div class="absolute w-full h-full transform -translate-x-full z-40 xl:hidden" id="mobile-nav">
            ...
            <div
                class="w-64 z-40 fixed overflow-y-auto top-0 bg-white shadow h-full flex-col justify-between xl:hidden pb-4 transition duration-150 ease-in-out">
