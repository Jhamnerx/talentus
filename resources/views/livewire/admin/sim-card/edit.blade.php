<x-form.modal.card title="Editar Sim card" blur wire:model.live="modalEdit" align="center" max-width="3xl">
            ...
            <tbody class="text-sm divide-y divide-slate-200">
                ...
                <tr>
                    ...
                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        ...
                        <x-form.input placeholder="imei sim card" wire:model.live="imei" />
                    </td>
                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
