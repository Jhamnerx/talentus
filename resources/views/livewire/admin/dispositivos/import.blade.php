<div>
    <div x-data="{ modalImport: @entangle('modalImport').live }">

        <!-- Modal backdrop -->
        <div class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" x-show="modalImport"
        ...
        <div id="basic-modal"
            ...
            role="dialog" aria-modal="true" x-show="modalImport"
            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                @click.outside="modalImport = false" @keydown.escape.window="modalImport = false">
                <!-- Modal header -->
                <div class="px-5 py-3 border-b border-slate-200">
                    <div class="flex justify-between items-center">
                        <div class="font-semibold text-slate-800">IMPORTAR DISPOSITIVOS</div>
                        <button class="text-slate-400 hover:text-slate-500" @click="modalImport = false">
