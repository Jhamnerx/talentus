<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            --}}
            <!-- Import button -->
            @livewire('admin.lineas.lineas-import')
        </div>
        <!-- Left side -->
        {{$operador}}
                    ...
                    <tbody class="text-sm divide-y divide-slate-200">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                ...
                                <div class="text-left font-medium text-slate-800">{{$linea->sim_card->sim_card}}</div>
                                @else
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                ...
                                <div class="text-left font-medium text-slate-800">{{$linea->old_sim_card}}</div>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="javascript: void(0)"
                                                        ...
                                                        disabled="true" id="headlessui-menu-item-28" role="menuitem"
                                                        tabindex="-1">
