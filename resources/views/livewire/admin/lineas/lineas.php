...
if ($request->numero) {
    ...
    if ($sim_card) {
        ...
        return redirect()->route('admin.almacen.sim-card.index')->with('asign', 'Se asigno la linea');
    }
} else {
    ...
    return redirect()->route('admin.almacen.sim-card.index')->with('asign', 'Se Asigno y se guardo el numero');
}
        ...
        // return redirect()->route('admin.almacen.sim-card.index')->with('update', 'Se asigno el número con exito');
