<div>
    <x-form.modal.card title="Agregar Contacto" blur wire:model.live="showModal" align="center">
        <div class="space-y-4">
            ...
            <x-form.select wire:model="tag_id" label="Grupo" placeholder="Selecciona un grupo">
                @foreach ($tags as $tag)
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-3">
                ...
                <x-form.button wire:click="save" spinner="save" primary label="Guardar Contacto" />
            </div>
        </x-slot>
    </x-form.modal.card>
</div>
