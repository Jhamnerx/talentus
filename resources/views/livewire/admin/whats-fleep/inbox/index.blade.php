<div class="flex h-[calc(100vh-4rem)] w-full overflow-hidden bg-gray-100 dark:bg-gray-950" x-data="{ hasConversation: @js(filled($conversation)) }"
    ...
    <main @class([
        ...
        <div class="pointer-events-none absolute inset-0 opacity-[0.06] dark:opacity-[0.04]"
        ...
        @else
            ...
            <div class="relative z-10 flex flex-1 flex-col items-center justify-center px-8 text-center">
                <div
                    class="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-emerald-500/10 ring-1 ring-emerald-500/20 dark:bg-emerald-400/10">
                    <svg class="h-12 w-12 text-emerald-600 dark:text-emerald-400" fill="currentColor" viewBox="0 0 24 24"
                        aria-hidden="true">
                        <path
    ...
    @if (filled($conversation))
        <aside
            class="hidden w-80 shrink-0 border-l border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 xl:flex xl:flex-col">
