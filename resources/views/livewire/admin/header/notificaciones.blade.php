<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div class="origin-top-right z-10 sm:max-w-md absolute top-full min-w-80 w-96  right-0 -mr-48 sm:mr-0 max-w-lg bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        <ul class="">
            @foreach ($notificaciones as $notificacion)
                <li x-show="open" x-data="{ open: true }"
                    class="border-b border-slate-200 last:border-0 mt-0 shadow-lg">
                    <div
                        class="inline-flex flex-col max-w-lg px-2 py-2 rounded-sm text-sm bg-white shadow-lg  hover:bg-slate-50">
