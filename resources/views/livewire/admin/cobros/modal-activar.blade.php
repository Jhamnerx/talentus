<div class="m-1.5 flex">
    ...
    <div x-data="{ modalActivar: @entangle('openModalActivar') }">
        ...
        <div id="danger-modal"
            ...
            role="dialog" aria-modal="true" x-show="modalActivar"
            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                @click.outside="modalActivar = false" @keydown.escape.window="modalActivar = false">
                <div class="p-5 flex space-x-4">
                    ...
                    <div>
                        <!-- Modal header -->
                        <div class="mb-2">
                            <div class="text-lg font-semibold text-slate-800">Activar Servicio</div>

                        </div>
                        <!-- Modal content -->
                        <div class="text-sm mb-10">
                            <div class="space-y-2">
                                <p> Estas seguro de Activar este Servicio?. </p>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="flex flex-wrap justify-end space-x-2 text-right">
                            <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                @click="modalActivar = false">Cancelar</button>
                            <button wire:click="ActivarCobro" class="btn-sm bg-green-500 hover:bg-green-600 text-white"
