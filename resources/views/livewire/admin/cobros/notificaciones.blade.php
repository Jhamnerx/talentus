<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-12 gap-2 items-center">
            ...
            <!-- Toggle: Mostrar pagadas / canceladas -->
            <div class="col-span-12 flex items-center justify-end gap-2 mt-1">
                <button wire:click="$toggle('mostrarPagadas')" @class([
                    'inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium border transition cursor-pointer',
                    'bg-emerald-50 border-emerald-300 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:border-emerald-700 dark:text-emerald-400 dark:hover:bg-emerald-900/50' => $mostrarPagadas,
                    'bg-gray-100 border-gray-300 text-gray-500 hover:bg-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-600' => !$mostrarPagadas,
                ])>
                    {{-- Icono eye / eye-slash --}}
                    @if ($mostrarPagadas)
                    ...
                    @else
                        ...
                        @if ($countOcultas > 0)
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-400 dark:bg-gray-500 text-white text-[10px] font-bold">
                                {{ $countOcultas > 99 ? '99+' : $countOcultas }}
                            </span>
                        @endif
                    @endif
                </button>
