<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-gray-100 font-bold">Certificados Antifatiga</h1>
        </div>
                            ...
                            <tr wire:key='certv-{{ $certificado->id }}'
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-sky-500">
                                        ...
                                        {{ str_pad($certificado->id, 5, '0', STR_PAD_LEFT) }}
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1">
                                        <a target="_blank"
                                            href="{{ route('admin.pdf.antifatiga', ['certificado' => $certificado, 'vehiculo' => $certificado->vehiculo]) }}">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800 dark:text-gray-100 truncate"
