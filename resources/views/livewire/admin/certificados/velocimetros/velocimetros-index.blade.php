                            ...
                            @foreach ($certificados as $certificado)
                                <tr>
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                        <div class="space-x-1">
                                            <a target="_blank"
                                                href="{{ route('admin.pdf.velocimetros', $certificado) }}">
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div class="font-medium text-slate-800">{{ $certificado->vehiculos->placa }}
                                        </div>
                                    </td>
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div>
                                            <div class="m-3 ">
                                                ...
                                                @livewire('admin.certificados.velocimetros.change-status', ['model' => $certificado, 'field' => 'estado'], key('estado' . $certificado->id))
                                                <!-- End -->
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                        <div class="space-x-1">
                                            ...
                                            <form class="inline-flex formularioEliminar"
                                                action="{{ route('admin.certificados.velocimetros.destroy', $certificado) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
