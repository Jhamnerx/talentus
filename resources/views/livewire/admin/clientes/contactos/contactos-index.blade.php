                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center gap-1">
                                        {{-- Gerente --}}
                                        <svg title="Gerente" class="w-4 h-4 shrink-0 fill-current {{ $contacto->is_gerente ? 'text-yellow-500' : 'text-slate-300 dark:text-slate-600' }}"
                                            viewBox="0 0 16 16">
                                            <path d="M8 0L6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934h-6L8 0z" />
                                        </svg>
                                        {{-- Responsable de cobros --}}
                                        <svg title="Responsable de cobros" class="w-4 h-4 shrink-0 fill-current {{ $contacto->is_cobros ? 'text-green-500' : 'text-slate-300 dark:text-slate-600' }}"
                                            viewBox="0 0 20 20">
