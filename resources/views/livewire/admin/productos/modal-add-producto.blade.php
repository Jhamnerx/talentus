<x-admin.facturacion.form-modal-w-buttons titulo="NUEVO ITEM" wire:model.live="showModal" maxWidth="2xl">
    ...
    <div class="col-span-12 md:col-start-5 md:col-span-4">
        ...
        <x-form.currency prefix="{{ $divisa == 'PEN' ? 'S/ ' : '$' }}" id="total_invoice_ref" name="total_invoice_ref"
            wire:model.live="prepayments.total_invoice_ref" precision="2" disabled />
    </div>
    @else
    ...
    <div class="col-span-12 md:col-start-5 md:col-span-4">
        ...
        <x-form.number id="cantidad" name="cantidad" wire:model.live="selected.cantidad" min="1" step="1" />
    ...
    <div class="col-span-12 md:col-start-5 md:col-span-4">
        ...
        <x-form.currency id="valor_venta_ref" name="valor_venta_ref" prefix="{{ $divisa == 'PEN' ? 'S/ ' : '$' }}"
            wire:model.live="prepayments.valor_venta_ref" precision="4" />
    ...
    <div class="col-span-12 md:col-start-5 md:col-span-4">
        ...
        <x-form.currency id="valor_unitario" name="valor_unitario" prefix="{{ $divisa == 'PEN' ? 'S/ ' : '$' }}"
            wire:model.blur="selected.valor_unitario" precision="4" />
    ...
    <div class="col-span-4 md:col-span-2">
        ...
        <x-form.radio id="exonerado" name="exonerado" value="20" wire:model.live="tipo_afectacion" label="Exonerado" />
    </div>
    <div class="col-span-4 md:col-span-2">

        <x-form.radio id="inafecto" name="inafecto" value="30" wire:model.live="tipo_afectacion" label="Inafecto" />
    </div>
