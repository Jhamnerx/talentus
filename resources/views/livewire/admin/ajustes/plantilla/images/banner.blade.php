    ...
    <div class="bg-white dark:bg-gray-800 rounded shadow-lg overflow-auto w-full max-h-full"
        ...
        <div class="px-5 py-3 border-b border-slate-200 dark:border-gray-700">
            <div class="flex justify-between items-center">
                <div class="font-semibold text-slate-800 dark:text-gray-100 uppercase">IMAGEN banner</div>
            </div>
        </div>
        <!-- content -->
        @if ($plantilla->banner)
        ...
        @else
            <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6" x-data="{ file: @entangle('banner').live, files: null }">
                @if ($banner)
