<div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3">
    <div class="bg-white rounded shadow-lg overflow-auto w-full max-h-full"
        ...
        @else
        <div class="px-4 py-5 bg-white sm:p-6" x-data="{ file: @entangle('logo'), files: null }">
            @if ($logo)
            <div class="px-5 py-2 border-b ">
                <div class="flex justify-between items-center">
                    <label class="block text-sm font-medium text-gray-700">
                    </label>
                    <button wire:click="$set('logo', null)" @click="files = null" type="button"
        ...
        <div class="px-5 py-4 border-t border-slate-200">
            <div class="flex flex-wrap justify-end space-x-2">
                ...
                @if ($plantilla->logo)
                <button wire:click="openModalDelete('Imagen Logo', 'logo')" type="button"
                    class="mr-2 btn-sm bg-red-500 hover:bg-red-600 text-white">
                    Eliminar
                </button>
                @else
