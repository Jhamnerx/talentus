<div class="grid grid-cols-12 gap-4 mt-4 pt-4 pb-4 bg-white dark:bg-gray-800 px-3 mb-2">
    <div class="max-w-3xl  col-span-6">
        ...
        <h3 class="text-xl leading-snug text-slate-800 dark:text-gray-100 font-bold mb-6">CONFIGURACIÓN EMPRESA</h3>

    </div>

    <div class="col-span-12 mx-3 rounded bg-white dark:bg-gray-800/60 overflow-hidden shadow-2xl">

        <div class="grid grid-cols-12 gap-4 mt-4 pt-4 pb-4 px-3 mb-2">
            <div class="max-w-3xl col-span-12">

                <h3 class="text-base leading-snug text-slate-800 dark:text-gray-100 font-bold mb-6">DATOS EMPRESARIALES
                </h3>
            ...
            <div class="px-4 py-3 col-span-12 bg-white dark:bg-gray-800/60 text-right sm:px-6">
    ...
    <div class="col-span-12 mx-3 rounded bg-white dark:bg-gray-800/60 overflow-hidden shadow-2xl">
        <div class="grid grid-cols-12 gap-4 mt-4 pt-4 pb-4 px-3 mb-2">
            ...
            <div class="max-w-3xl col-span-12">
                ...
                <h3 class="text-base leading-snug text-slate-800 dark:text-gray-100 font-bold mb-6">TERMINOS</h3>
    ...
    <div class="col-span-12 mx-3 rounded bg-white dark:bg-gray-800/60 overflow-hidden shadow-2xl">
        <div class="grid grid-cols-12 gap-4 mt-4 pt-4 pb-4 px-3 mb-2">
            <div class="max-w-3xl col-span-12">
                ...
                <h3 class="text-base leading-snug text-slate-800 dark:text-gray-100 font-bold mb-6">DIRECCIÓN</h3>
    ...
    <div class="col-span-12 mx-3 rounded bg-white dark:bg-gray-800/60 overflow-hidden shadow-2xl">
        <div class="grid grid-cols-12 gap-4 mt-4 pt-4 pb-4 px-3 mb-2">
            ...
            <div class="max-w-3xl col-span-12">
                ...
                <h3 class="text-base leading-snug text-slate-800 dark:text-gray-100 font-bold mb-6">CONFIGURACION DE
                    CORREO</h3>
