<x-form.modal.card title="Crear Rol" blur wire:model.live="openModalSave" align="center" max-width='6xl'>
    ...
    <div class="px-4 md:px-8 py-4 md:py-6">
        ...
        <div class="relative w-full text-left mt-4">
            <label for="save_route_redirect" class="block text-sm font-medium text-gray-800 dark:text-gray-300 mb-1">
                Ruta al iniciar sesión
                <span class="text-xs text-gray-400 font-normal ml-1">(opcional)</span>
            </label>
            <input id="save_route_redirect" name="route_redirect" wire:model="route_redirect" list="rutas_list_save"
                type="text" autocomplete="off" placeholder="Escribe o selecciona una ruta…"
                class="font-base block w-full sm:text-sm border-gray-200 rounded-md text-black focus:ring-indigo-400 focus:border-indigo-400">
            <datalist id="rutas_list_save">
            ...
            <div class="flex flex-col space-y-1">
                ...
                <div class="flex">
                    <div class="relative flex items-start" variant="indigo">
                        <div class="flex items-center h-5">
                            <input name="permission[]" wire:model.live="permission"
                                value="admin.usuarios.impersonate" id="admin.usuarios.impersonate" variant="indigo"
                                type="checkbox"
                                class="w-4 h-4 border-gray-300 rounded cursor-pointer text-indigo-600 focus:ring-indigo-500">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="admin.usuarios.impersonate"
                                class="font-medium text-gray-600 cursor-pointer">
