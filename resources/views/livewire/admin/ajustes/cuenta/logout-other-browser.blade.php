<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            ...
            Algunas de sus
            sesiones recientes se enumeran a continuación; sin embargo, es posible que esta lista no sea exhaustiva. Si
            cree que su
            cuenta se ha visto comprometida, también debería actualizar su contraseña.
        </div>
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Password') }}"
                        x-ref="password" wire:model.live="password" wire:keydown.enter="logoutOtherBrowserSessions" />
