<x-form.modal.card title="EDITAR SECTOR" max-width="lg" wire:model.live="openModal">
    <div class="space-y-4 p-1">
        ...
        <div class="flex items-center gap-3">
            <x-form.checkbox wire:model.live="is_active" id="edit-sector-active" />
            <label for="edit-sector-active" class="text-sm text-gray-700 dark:text-gray-300">Sector activo</label>
        </div>
    </div>
    <x-slot name="footer">
