<x-form.modal.card title="AÑADIR RUBRO DE CLIENTE" max-width="lg" wire:model.live="openModal">
    <div class="space-y-4 p-1">
        ...
        <div class="flex items-center gap-3">
            <x-form.checkbox wire:model.live="is_active" id="save-rubro-active" />
            <label for="save-rubro-active" class="text-sm text-gray-700 dark:text-gray-300">Rubro activo</label>
        </div>
    </div>
    <x-slot name="footer">
