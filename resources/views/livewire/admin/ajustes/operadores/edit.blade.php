<x-form.modal.card title="EDITAR OPERADOR" max-width="lg" wire:model.live="openModalEdit" align="center">

    <form autocomplete="off">
        <div class="px-6 py-5 space-y-5">

            <div>
                <label class="block text-sm font-medium mb-1" for="op-edit-name">
                    Nombre <span class="text-rose-500">*</span>
                </label>
                <input wire:model.live="name" id="op-edit-name" name="name" type="text"
            ...
            <div class="flex items-center gap-3">
                <input wire:model.live="have_api" id="op-edit-have-api" type="checkbox"
                    class="form-checkbox rounded text-indigo-500" />
                <label for="op-edit-have-api" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Tiene integración API
                </label>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1" for="op-edit-api-slug">
                    API Slug
                    <span class="text-slate-400 font-normal">(opcional)</span>
                </label>
                <input wire:model.live="api_slug" id="op-edit-api-slug" name="api_slug" type="text"
