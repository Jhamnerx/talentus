<div>
    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            <!-- Close button -->
            <button
                class="lg:hidden text-slate-500 hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                ...
                <ul class="mt-3">
                    ...
                    @role('admin')
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            ...
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('dashboard-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            <path
                                                class="fill-current {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                                                :class="page.startsWith('dashboard-') &&
                                                    '!text-blue-800'"
                                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z" />
                                            <path class="fill-current text-sky-900"
                                                :class="page.startsWith('dashboard-') && 'text-indigo-900'"
                                    ...
                                    <div
                                        ...
                                        <svg class="w-3 h-3 shrink-0 ml-1 fill-current {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    <li class="mb-1 last:mb-0">
                                        <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                            :class="page === 'dashboard-inicio' &&
                                                '!text-blue-800'"
                    ...
                    @canany(['ver-categoria', 'ver-producto', 'ver-sim_card', 'ver-dispositivo', 'ver-guias'])
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            ...
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('almacen-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('almacen-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-700"
                                                :class="page.startsWith('almacen-') && '!text-indigo-900'"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    ...
                                    @can('ver-dispositivo')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'almacen-dispositivos' &&
                                                    '!text-blue-800'"
                    ...
                    @canany(['ver-cliente', 'ver-contacto'])
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            ...
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('clientes-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('clientes-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                    ...
                    @can('ver-proveedor')
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            :class="page === 'proveedores' && 'bg-blue-950'">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page === 'proveedores' &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="{{ route('admin.proveedores.index') }}">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                        <path class="fill-current text-sky-900"
                                            :class="page.startsWith('proveedores-') &&
                                                'text-blue-800'"
                                            d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z" />
                                        <path
                                            class="fill-current {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                    ...
                    @canany(['ver-compras_facturas', 'crear-compras_facturas'])
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            ...
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('compras-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('compras-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                    ...
                    <!-- Comprobantes -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if (in_array(Request::segment(2), ['emitir', 'ventas'])) {{ $empresa->nombre == 'talentus' ? 'bg-blue-950' : 'bg-orange-200' }} @endif"
                        x-data="{ open: {{ in_array(Request::segment(2), ['emitir', 'ventas']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if (in_array(Request::segment(2), ['emitir'])) {{ 'hover:text-slate-200' }} @endif"
                            href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                        <path
                                            class="fill-current @if (in_array(Request::segment(2), ['emitir', 'ventas'])) {{ 'text-indigo-300' }}@else{{ 'text-slate-400' }} @endif"
                                            d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z" />
                                        <path
                                            class="fill-current @if (in_array(Request::segment(2), ['emitir', 'ventas'])) {{ 'text-indigo-600' }}@else{{ 'text-slate-700' }} @endif"
                                            d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z" />
                                        <path
                                            class="fill-current @if (in_array(Request::segment(2), ['emitir', 'ventas'])) {{ 'text-indigo-500' }}@else{{ 'text-slate-600' }} @endif"
                                            d="M13 15.047V24l10.573-7.181A.999.999 0 0024 16V8l-11 7.047z" />
                                    </svg>
                                    <span
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 @if (!in_array(Request::segment(2), ['ventas'])) {{ 'hidden' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.ventas.index')) {{ '!text-blue-800' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.factura.create')) {{ '!text-blue-800' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.boleta.create')) {{ '!text-blue-800' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.nota.venta.create')) {{ '!text-blue-800' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.nota.credito.create')) {{ '!text-blue-800' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('admin.nota.debito.create')) {{ '!text-blue-800' }} @endif"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                ...
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    @can('ver-cotizaciones')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'ventas-presupuestos' &&
                                                    '!text-blue-800'"
                    ...
                    @canany(['ver-vehiculos-flotas', 'ver-vehiculos-vehiculos', 'ver-vehiculos-reportes'])
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            :class="{
                                '{{ $empresa->nombre == 'talentus' ? 'bg-blue-950' : 'bg-orange-200' }}': page
                                    .startsWith('vehiculos-')
                            }"
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('vehiculos-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('vehiculos-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    ...
                                    @can('ver-vehiculos-vehiculos')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'vehiculos-vehiculos' &&
                                                    '!text-blue-800'"
                                    ...
                                    <li class="mb-1 last:mb-0">
                                        <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                            :class="page === 'vehiculos-mantenimiento' &&
                                                '!text-blue-800'"
                    ...
                    @canany(['ver-certificados-actas', 'ver-certificados-gps', 'ver-certificados-velocimetros'])
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            :class="{
                                '{{ $empresa->nombre == 'talentus' ? 'bg-blue-950' : 'bg-orange-200' }}': page
                                    .startsWith('certificados-')
                            }"
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('certificados-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('certificados-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                ...
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    ...
                                    @can('ver-certificados-velocimetros')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'certificados-velocimetro' &&
                                                    '!text-blue-800'"
                    ...
                    @canany(['admin.solicitudes.index', 'admin.reportes.index', 'admin.usuarios.index',
                        ...
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            :class="{
                                '{{ $empresa->nombre == 'talentus' ? 'bg-blue-950' : 'bg-orange-200' }}': page
                                    .startsWith('administracion-')
                            }"
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('administracion-'))">
                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white truncate transition duration-150"
                                :class="page.startsWith('administracion-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!open && 'hidden'" x-cloak>
                                    @can('admin.solicitudes.index')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-solicitudes' &&
                                                    '!text-blue-800'"
                                    ...
                                    <li class="mb-1 last:mb-0">
                                        <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                            :class="page === 'administracion-reviews' &&
                                                '!text-blue-800'"
                                    ...
                                    @can('admin.reportes.index')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-reportes-gerenciales' &&
                                                    '!text-blue-800'"
                                    ...
                                    @can('admin.usuarios.index')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-usuarios' &&
                                                    '!text-blue-800'"
                                    ...
                                    @can('admin.cobros.index')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-cobros' &&
                                                    '!text-blue-800'"
                                    ...
                                    @can('admin.payments.index')
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-paymentes' &&
                                                    '!text-blue-800'"
                                    ...
                                    <li class="mb-1 last:mb-0">
                                        <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                            :class="page === 'administracion-recibos' &&
                                                '!text-blue-800'"
                                    ...
                                    @canany(['admin.settings.ciudades.index', 'admin.settings.roles.index',
                                        ...
                                        <li class="mb-1 last:mb-0">
                                            <a class="block {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }} hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} transition duration-150 truncate"
                                                :class="page === 'administracion-ajustes' &&
                                                    '!text-blue-800'"
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
                            ...
                            x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('tecnico-'))">
                            <a class="sidebar-expander-link block {{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }} hover:text-white transition duration-150"
                                :class="page.startsWith('tecnico-') &&
                                    'hover:{{ $empresa->nombre == 'talentus' ? 'text-slate-200' : 'text-blue-950' }}'"
                                href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <line class="fill-current text-sky-900" x1="4" y1="5"
                                                x2="8" y2="5" />
                                            <path d="M6 5v11a1 1 0 0 0 1 1h5" />
                                            <rect
                                                class="fill-current {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                                                x="12" y="7" width="8" height="4" rx="1" />
                                            <rect
                                                class="fill-current {{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
                                                x="12" y="15" width="8" height="4" rx="1" />
                                        </svg>
                                        <span
                                            class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                            Tareas
            ...
            <div class="px-3 py-2">
                <button @click="sidebarExpanded = !sidebarExpanded">
                    ...
                    <svg class="w-6 h-6 fill-current sidebar-expanded:rotate-180" viewBox="0 0 24 24">
                        <path class="{{ $empresa->nombre == 'talentus' ? 'text-slate-400' : 'text-sky-700' }}"
