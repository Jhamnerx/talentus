    ...
    <x-form.modal.card title="Crear Producto" blur wire:model.live="modalCreate" align="center">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-3">
                ...
                <x-form.number id="stock" name="stock" wire:model="stock" label="Stock:" />
            ...
            @if ($tipo === 'servicio')
                <div class="col-span-12">
                    ...
                    @if ($yaExisteServicioCobro)
                        <p class="mt-1 text-xs text-amber-600 dark:text-amber-400">Ya existe un servicio de cobro
                            registrado para esta empresa.</p>
                    @endif
                </div>
            @endif
