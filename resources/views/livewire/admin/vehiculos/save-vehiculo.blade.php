<x-form.modal.card title="REGISTRAR VEHICULO" blur wire:model.live="modalCreate" align="center">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 sm:col-span-6">
            ...
            <x-form.select label="Selecciona una linea:" name="numero" id="numero" wire:model.live="numero"
        ...
        <div class="col-span-12 sm:col-span-6">
            {{ $dispositivo_imei }}
            <x-form.select label="IMEI GPS:" name="dispositivo_imei" id="dispositivo_imei"
