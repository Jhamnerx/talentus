                                            ...
                                            <div
                                                ...
                                                <div class="relative h-full flex flex-col justify-between">
                                                    ...
                                                    <svg class="absolute bottom-0 right-0" width="48"
                                                        ...
                                                        <circle fill="#590BDD" cx="34" cy="14"
                                                            r="14" fill-opacity=".8" />
                                                        <circle fill="#F4DF33" cx="14" cy="14"
                                                            r="14" fill-opacity=".8" />
                                                    </svg>
                                                </div>
                                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex items-center mb-2">
                                ...
                                <div class="grow">
                                    ...
                                    <div class="text-xs font-medium text-slate-500">
                                        {{ $vehiculo->cliente->created_at->format('h:m a, d-m-Y') }}</div>
                                </div>
                            </div>
                            <!-- Content -->
                            @can('editar-cliente')
                                    ...
                                    <div class="text-sm">
                                        ...
                                        @if ($vehiculo->cliente)
                                            <a class="font-medium text-indigo-500 hover:text-indigo-600"
                                                href="{{ route('admin.clientes.edit', $vehiculo->cliente) }}">#Editar</a>
                                        @else
                            ...
                            <div class="max-w-sm w-full mx-auto lg:max-w-none">
                                ...
                                @if ($vehiculo->dispositivos)
                                    <h2 class="text-2xl text-slate-800 font-bold mb-6">
                                        ...
                                        {{ $vehiculo->dispositivos->modelo->marca }}
                                    </h2>
                                @endif
