                ...
                <form autocomplete="off">
                    <div class="px-8 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                <label class="block text-sm font-medium mb-1" for="vehiculos_id_edit">Vehiculo: <span
                                        class="text-rose-500">*</span></label>
                                <div class="relative" wire:ignore lang="es">

                                    <select id="vehiculos_id_edit" name="vehiculos_id_edit"
                                        class="vehiculos_id_edit w-full form-input pl-9 " required>
