<div>
    <!-- Start -->
    <div x-data="{ modalContacto: @entangle('openModalContactos').live }">
            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                ...
                <div class="px-5 py-3 border-b border-slate-200">
                    <div class="flex justify-between items-center">
                        <div class="font-semibold text-slate-800">CONTACTOS</div>
                ...
                <div class="px-5 pt-4 pb-1">
                    <div class="text-sm">
                        <div class="mb-4">Aqui se muestran los contactos disponibles:</div>
                        <!-- Options -->
                        <ul class="space-y-2 mb-4">
                            ...
                            <div class="text-xs text-slate-500">Aqui solo estan los contactos registrados en el sistema,
                                Solicita registrar si falta alguno</div>
                    </div>
                </div>
                <!-- Modal footer -->
                <div class="px-5 py-4">
