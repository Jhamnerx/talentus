<div class="m-1.5">
    <div x-data="{ modalOpen: false }">
        {{-- @livewire('admin.vehiculos.flotas.edit', ['model' => $model], key($model->id)) --}}
        <a href="{{route('admin.vehiculos.flotas.edit', $model)}}">
            ...
            <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                ...
                <div class="p-5 flex space-x-4">
                    ...
                    <div>
                        <!-- Modal header -->
                        <div class="mb-2">
                            <div class="text-lg font-semibold text-slate-800">Eliminar Flota</div>

                        </div>
                        <!-- Modal content -->
                        <div class="text-sm mb-10">
                            <div class="space-y-2">
                                <p> Estas seguro de eliminar esta Flota?. </p>
                            </div>
                        </div>
                        <!-- Modal footer -->
