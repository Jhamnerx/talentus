<div>
    ...
    <div x-data="{ modalOpenEdit: @entangle('modalOpenEdit') }">
        ...
        <div class="relative inline-flex">
            ...
            <button wire:click="openModal" class="text-slate-400 hover:text-slate-500 rounded-full">
        ...
        <!-- Modal backdrop -->
        <div class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" x-show="modalOpenEdit"
            ...
            <div class="bg-white rounded shadow-lg overflow-auto w-full md:w-3/4 lg:w-6/12 xl:w-6/12 2xl:w-1/3 max-h-full"
                ...
                <div class="px-5 py-3 border-b border-slate-200">
                    <div class="flex justify-between items-center">
                        <div class="font-semibold text-slate-800">EDITAR FLOTA</div>
                        <button class="text-slate-400 hover:text-slate-500" @click="modalOpenEdit = false">
