                    ...
                    <div class="px-1 mt-6">
                        <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                            <div class="flex flex-wrap border-b border-gray-200 undefined">
                                <div wire:click="openWithoutReading"
                                    class="bg-gradient-to-tr from-sky-400 to-sky-600 hover:scale-75 ease-in duration-500 cursor-pointer -mt-10 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg-blue mb-0">
                                ...
                                <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                                    <h5 class="text-gray-900 font-light tracking-wide text-base xl:text-lg mb-1">VER
                                        TAREAS</h5>
                                    <span class="text-base xl:text-lg text-gray-700">10 Sin Leer</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col w-full rounded-sm">
                    <div class="px-1 mt-6">
                        <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                            <div class="flex flex-wrap border-b border-gray-200 undefined">
                                <div wire:click="openWithoutReading"
                                    class="bg-gradient-to-tr from-emerald-400 to-emerald-600 hover:scale-75 ease-in duration-500 cursor-pointer -mt-10 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg-blue mb-0">
                                    <svg class="w-full fill-white" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 64 64">
                                        <g stroke-linecap="square" stroke-width="2" fill="none" stroke="currentColor"
                                            stroke-linejoin="miter" class="nc-icon-wrapper" stroke-miterlimit="10">
                                ...
                                <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                                    <h5 class="text-gray-900 font-light tracking-wide text-base xl:text-lg mb-1">TAREAS
                                        TERMINADAS</h5>
                                    <span class="text-base xl:text-lg text-gray-700">20</span>
                                </div>
                            </div>
                        </div>
                    </div>
