<div x-data="{ openModal: false }">
    ...
    <div x-show="openModal"
        ...
        x-transition:leave-end="opacity-0 translate-y-4" x-cloak @keydown.escape.window="openModal = false">
        <!-- Cabecera del modal -->
        ...
        <header class="pt-6 pb-4 px-5 border-b border-gray-200">
                ...
                <div class="flex items-center">
                    ...
                    <div class="pr-1">
                        <a class="inline-flex text-gray-800 hover:text-gray-900" href="#0">
                            <h2 class="text-xl leading-snug font-bold">Empresa Nombre</h2>
                        </a>
                        <a class="block text-sm font-medium hover:text-indigo-500" href="#0">@talentus.eirl</a>
                    </div>
                </div>
                <!-- Settings button -->
            ...
            <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                <div class="flex items-center">
                    ...
                    <span class="text-sm whitespace-nowrap ml-2">Direccion, CJ</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-4 h-4 fill-current flex-shrink-0 text-gray-400" viewBox="0 0 16 16">
                        <path
