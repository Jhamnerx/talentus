<div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">Guias Remision: <span class="text-slate-400 font-medium">{{
                    $guias->total() }}</span>
            </h2>
        </header>
        <div>
                        ...
                        <tr class="hover:cursor-pointer hover:shadow-md">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                ...
                                <div class="space-x-1">
                                    ...
                                    {{-- OBTENER CDR --}}
                                    @case('0')
                                    <x-form.mini.button flat wire:click.prevent="consultaTicket({{ $guia->id }})" teal
                                        icon="arrow-path" spinner='consultaTicket({{ $guia->id }})' />
                                    @break
                                            ...
                                            <button
                                                ...
                                                <div class="flex items-center truncate">
                                                    <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg"
                                                        height="511pt" version="1.1" viewBox="-38 0 511 511.99956"
                                                        width="511pt">
                                                        <g id="surface1">
                                                            <path
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <div class="py-1" role="menu" aria-orientation="vertical"
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-full">
                                                        <x-form.badge indigo md label="{{ $guia->estado_texto }}" />
                                                    </div>
                                                </div>
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <div class="py-1 min-w-80" role="menu" aria-orientation="vertical"
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-full">
                                                        <x-form.badge indigo md label="{{ $guia->fe_codigo_error }}" />
                                                    </div>
                                                </div>
                                                <div
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                ...
                                <div class=" text-center space-x-1">
                                    <x-form.dropdown class="w-60">
                                        ...
                                        <x-form.dropdown.item wire:click.prevent='createXml({{ $guia->id }})'
                                        ...
                                        @can('eliminar-guias')
                                        <x-form.dropdown.item wire:click.prevent="openModalDelete({{ $guia->id }})"
