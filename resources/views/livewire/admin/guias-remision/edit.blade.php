    ...
    <div class="px-4 py-2 bg-gray-100 sm:p-6">
        ...
        <div class="grid grid-cols-12 gap-4 mb-3">
            ...
            <div class="col-span-6 sm:col-span-3 mb-2">
                ...
                <x-form.inputs.number id="peso" name="peso" step="0.1" wire:model.live="peso"
                    label="Peso Bruto (Kg):" />
            ...
            <div class="col-span-6 sm:col-span-3 mb-2">
                ...
                <x-form.inputs.number id="cantidad_items" name="cantidad_items" wire:model.live="cantidad_items"
