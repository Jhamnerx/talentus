<x-form.modal.card title="Registrar Pago" wire:model="showModal" blur max-width="md">
    @if ($cuenta)
        <div class="space-y-4">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/20 p-4 rounded-lg space-y-2">
                <div class="flex justify-between">
                    ...
                    <span
                        class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $cuenta->cliente->nombre_completo }}</span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between border-t pt-2">
                    ...
                    <span class="text-base font-bold text-amber-600 dark:text-amber-400">S/
            ...
            <div class="space-y-4">
                ...
                <x-form.textarea label="Referencia / Observaciones" placeholder="N° de operación, notas adicionales..."
