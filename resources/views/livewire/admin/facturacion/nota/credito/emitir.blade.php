        ...
        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-700 sm:p-6">
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-dashed lg:border-r-2 pr-0 md:pr-4 gap-2">
                    ...
                    {{-- FECHA EMISION --}}
                    <div class="col-span-12 xs:col-span-4 gap-2">
                    ...
                    <div class="col-span-12 xs:col-span-6">
                        <x-form.select always-fetch="true" id="sustento_id" name="sustento_id"
                            label="Tipo de Nota de Crédito:" wire:model.live="sustento_id"
                            placeholder="Selecciona el tipo" :async-data="[
                                'api' => route('api.sustentos.index'),
                                'params' => ['tipo_comprobante' => $tipo_comprobante_id],
                            ]" option-label="descripcion"
                            option-value="codigo" hide-empty-message />
                    </div>
                ...
                <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-red-600 lg:pl-6 mb-2 gap-2">
                    ...
                    {{-- INVOICE --}}
                    <div class="col-span-12 {{ $invoice_id ? 'md:col-span-6' : 'md:col-span-8' }}  mb-3">
                    ...
                    @if ($invoice_id)
                        <div class="col-span-12 md:col-span-2 mt-0 md:mt-7">
                    ...
                    <div class="col-span-12 xs:col-span-4 gap-2">
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <x-form.datetime-picker label="Fecha de Emision:" wire:model.live="invoice_fecha_emision"
                                :min="now()->subDays(1)" :max="now()" without-time parse-format="YYYY-MM-DD"
                                display-format="DD-MM-YYYY" :clearable="false" />
                    ...
                    {{-- FECHA --}}
                    <div class="col-span-12 xs:col-span-4 gap-2">
                        <x-form.datetime-picker label="Fecha Vencimiento:" wire:model.live="invoice_fecha_vencimiento"
