<div>
    <x-form.modal.card title="IMPORTAR PROVEEDORES" max-width="lg" wire:model.live="modalOpenImport">
        ...
        <div>
            <p class="mt-1 text-slate-500 text-sm">
                ...
                <a class="text-blue-800" href="{{ Storage::url('excel/proveedores.xlsx') }}" download>
                    Haz click aqui
                </a>
            </p>
        </div>
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-x-4">
                <x-form.button flat label="Cerrar" wire:click="closeModal()" x-on:click="files = null" />
                <x-form.button primary label="Importar" wire:click="importExcel" x-on:click="files = null" />
            </div>
        </x-slot>
    </x-form.modal.card>
</div>
