...
<div class="flex items-center justify-between w-full md:w-auto">
    <a href="{{ route('web.home') }}">
        <img class="h-14 w-36" src="{{ Storage::url('images/logo/logo-talentus.png') }}" alt="Talentus Logo">
    </a>
...
<div class="hidden md:block">
    <div class="ml-10 flex items-baseline space-x-4">
        ...
        @auth
            <a href="{{ route('admin.home') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-base font-bold"
                aria-current="page">Panel de Control</a>
        @endauth
        <a href="{{ route('web.home') }}"
        ...
        <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            <a class="text-white hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-base font-bold items-center transition duration-150 ease-in-out"
                href="#0" aria-haspopup="true" :aria-expanded="open" @focus="open = true" @focusout="open = false"
                @click.prevent>
                Plataformas
            </a>
            <!-- 2nd level: hover -->
            <div class="origin-top-right absolute top-full right-0 w-40 bg-white py-4 ml-4 rounded shadow-lg"
                ...
                <div>
                    <a class="font-bold text-base text-slate-600 hover:text-blue-600 flex py-2 px-5 leading-tight"
                        href="{{ route('plataforma.basica') }}" @focus="open = true" @focusout="open = false">Plataforma
                        Basica</a>
                </div>
                <div>
                    <a class="font-bold text-base text-slate-600 hover:text-blue-600 flex py-2 px-5 leading-tight"
        ...
        <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="ml-3 relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-on:click.away="open=false"
                    ...
                    <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-base text-gray-700" role="menuitem"
                        tabindex="-1" id="user-menu-item-0">Perfil</a>

                    <a href="ajustes" class="block px-4 py-2 text-base text-gray-700" role="menuitem" tabindex="-1"
                        id="user-menu-item-1">Ajustes</a>
                    <a href="{{ route('admin.home') }}" class="block px-4 py-2 text-base text-gray-700" role="menuitem"
                        tabindex="-1" id="user-menu-item-1">Sistema</a>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="{{ route('logout') }}" class="block px-4 py-2 text-base text-gray-700" role="menuitem"
