                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                {!! Form::select('roles[]', $roles, $user->getRoleNames() ? $user->getRoleNames()[0] : null, [
                                    'class' => 'form-input
                                                            w-2/4',
                                ]) !!}
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                <label for="tipo_documento" class="block text-sm font-medium mb-1">Tipo
                                    Documento:</label>

                                <select name="tipo_documento" id="tipo_documento" class="form-select w-full">
                                    <option value="DNI" @selected(old('tipo_documento') == 'DNI' || $user->tipo_documento == 'DNI')>DNI</option>
                                    <option value="RUC" @selected(old('tipo_documento') == 'RUC' || $user->tipo_documento == 'RUC')>RUC</option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                ...
                                <input type="text"
                                    value="{{ old('telefonos') ? old('telefonos') : $user->telefonos }}"
