                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Html::decode(Form::label('name','Nombre: <span class="text-rose-500">*</span>',
                            ['class' => 'block text-sm font-medium mb-1'])) !!}

                            {!! Form::text('name', null, ['class' => 'form-input w-full valid:border-emerald-300
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Html::decode(Form::label('email','Email: <span class="text-rose-500">*</span>',
                            ['class' => 'block text-sm font-medium mb-1'])) !!}

                            {!! Form::text('email', null, ['class' => 'form-input w-full valid:border-emerald-300
                            required:border-rose-300 invalid:border-rose-300 peer',
                            'required' =>'','placeholder' => 'Escribe el email']) !!}
                            @error('email')
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            {!! Html::decode(Form::label('roles','Rol: <span class="text-rose-500">*</span>',
                            ['class' => 'block text-sm font-medium mb-1'])) !!}


                            {!! Form::select('roles[]', $roles, null, ['form-select w-2/4']) !!}
                            @error('roles')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            {!! Form::label('password', 'Contraseña:', ['class' => 'block text-sm font-medium
                            mb-1']) !!}

                            {!! Form::password('password', ['class' => 'form-input w-full','placeholder' =>
                            'Escribe un password']) !!}
                            @error('password')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            {!! Form::label('password_confirmation', 'Confirmar Contraseña:', ['class' => 'block text-sm
                            font-medium
                            mb-1']) !!}

                            {!! Form::password('password_confirmation', ['class' => 'form-input w-full','placeholder' =>
                            'Escribe un password']) !!}
