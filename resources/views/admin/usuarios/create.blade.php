                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                {!! Html::decode(
                                    Form::label('name', 'Nombre: <span class="text-rose-500">*</span>', ['class' => 'block text-sm font-medium mb-1']),
                                ) !!}
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                {!! Html::decode(
                                    Form::label('email', 'Email: <span class="text-rose-500">*</span>', ['class' => 'block text-sm font-medium mb-1']),
                                ) !!}
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                {!! Html::decode(
                                    Form::label('roles', 'Rol: <span class="text-rose-500">*</span>', ['class' => 'block text-sm font-medium mb-1']),
                                ) !!}
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                {!! Form::password('password', ['class' => 'form-input w-full', 'placeholder' => 'Escribe un password']) !!}
                                @error('password')
                                    <p class="mt-2 peer-invalid:visible text-pink-600 text-sm">
                                        {{ $message }}
                                    </p>
