            ...
            <nav class="">
                <div class=" flex flex-row justify-between">
                    <div class=" flex space-x-3 items-center">
                        ...
                        <h1 class="  font-bold text-2xl leading-6 text-gray-800 dark:text-white ">FACTURA</h1>
                    </div>
                        ...
                        <div class=" xl:pl-16 lg:pl-4">
                            <div class=" flex space-x-1 items-center">
                                ...
                                <a class="focus:text-gray-700 hover:text-gray-700 duration-100 border-b border-gray-600 dark:border-gray-200 font-normal text-xs leading-3 text-gray-600 dark:text-gray-200 pb-1"
                                    href="{{ route('admin.compras.facturas.index') }}">Volver a facturas</a>
                            </div>
                ...
                <div class="lg:hidden flex flex-auto justify-between flex-row mt-4">
                    <div id="heading" class=" sm:block xl:pl-16 lg:pl-4">
                        ...
                        <h2 class=" font-bold text-xl leading-5 text-gray-800 dark:tet-white">Detalle de la Factura</h2>
                    </div>
            ...
            <article class="shadow-none md:shadow-md md:rounded-md overflow-hidden">
                <div class="md:rounded-b-md  bg-white"> {{-- aqui inicia --}}
                            ...
                            <div class="flex justify-between items-top">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="font-bold text-lg uppercase"> Factura de: </p>
                                        <p> {{ $factura->proveedores->razon_social }} </p>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <div>
                    ...
                    <div class="p-9 border-b border-gray-200">
                        ...
                        <p class="text-sm"> {{ $factura->nota }} </p>
                    </div>
                    ...
                    <div class="p-9 border-b border-gray-200 py-2 ml-auto mt-5 w-full sm:w-2/4 mr-2">
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-gray-800 text-sm total">{{ $factura->impuesto }}</div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-gray-800 text-sm total">{{ $factura->total }}</div>
                    ...
                    <div class="p-9 border-b border-gray-200">
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <p class="font-bold text-black text-lg"> {{ $factura->total }} </p>
                            </div>
                        </div>
                    </div>
                </div>
