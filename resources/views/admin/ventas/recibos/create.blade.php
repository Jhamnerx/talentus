...
@section('contenido')
    ...
    <div
        ...
        <div>
            <h4 class="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">CREAR RECIBO</h4>
    ...
    <div class="p-6 shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-2 bg-gray-50 sm:p-6">
            {!! Form::open(['route' => 'admin.ventas.recibos.store', 'class' => 'formularioRecibo']) !!}
                ...
                <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-dashed lg:border-r-2 pr-4 gap-2">
                        ...
                        <div class="relative">
                            ...
                            <input name="fecha" type="text"
                                class="form-input valid:border-emerald-300
                                    required:border-rose-300 invalid:border-rose-300 peer fechaEmision  font-base pl-8 py-2 outline-none focus:ring-primary-400 focus:outline-none focus:border-primary-400 block sm:text-sm border-gray-200 rounded-md text-black input w-full"
                    ...
                    <div class="col-span-6 gap-2">
                        ...
                        <div class="relative">
                            ...
                            <input name="fecha_pago" type="text"
                                class="form-input fechaPago valid:border-emerald-300
                        ...
                        <div class="py-2 ml-auto mt-5 w-full sm:w-2/4 lg:w-1/4 mr-2">
                            <div class="flex justify-between mb-3">
                                ...
                                <div class="text-right w-40">
                                    ...
                                    <input type="hidden" class="subTotalRecibo" name="subtotal">
                                </div>
                            </div>
                            {{-- <div class="flex justify-between mb-4">
                                ...
                                <div class="text-right w-40">
                                    ...
                                    <input type="hidden" class="impuestoRecibo" name="impuesto">
                                </div>
                            </div> --}}
                            ...
                            <div class="py-2 border-t border-b">
                                <div class="flex justify-between">
                                    ...
                                    <div class="text-right w-40">
                                        <div class="text-xl text-gray-800 font-bold totalRecibo"></div>
                                        <input type="hidden" class="totalRecibo" name="total">
                                    </div>
                                </div>
                            </div>
                        </div>
