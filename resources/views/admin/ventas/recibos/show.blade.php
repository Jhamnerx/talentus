            ...
            <nav class="">
                <div class=" flex flex-row justify-between">
                    <div class=" flex space-x-3 items-center">
                        ...
                        <h1 class="  font-bold text-2xl leading-6 text-gray-800 dark:text-white ">RECIBO</h1>
                    </div>
                    ...
                    <div class="lg:flex hidden flex-auto justify-between flex-row">
                        <div class=" xl:pl-16 lg:pl-4">
                            <div class=" flex space-x-1 items-center">
                                ...
                                <a class="focus:text-gray-700 hover:text-gray-700 duration-100 border-b border-gray-600 dark:border-gray-200 font-normal text-xs leading-3 text-gray-600 dark:text-gray-200 pb-1"
                                    href="{{ route('admin.ventas.recibos.index') }}">Volver a recibos</a>
                            </div>
                            <h2 class=" font-bold text-xl leading-5 text-gray-800 dark:text-white ">Detalle del recibo
                            </h2>
                        </div>
                        <div class="flex flex-row lg:space-x-3 xl:space-x-4">
                            ...
                            <button
                                ...
                                <p>Compartir</p>
                                <img class="mt-1" src="{{ asset('images/plantilla/admin/header-2-svg3.svg') }}"
                                    alt="share" />
                            </button>
                    ...
                    <div
                        ...
                        <a target="_blank" href="{{ route('admin.pdf.recibo', $recibo) }}">
                            <button
                                class="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-gray-800 bg-white focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">
                                <p>Ver</p>
                                <img src="{{ asset('images/plantilla/admin/header-2-svg4.svg') }}" alt="preview" />
                            </button>
                        </a>
                    ...
                    <div id="bgIcon" onclick="toggleMenu()"
                        ...
                        <img class="dark:bg-white" src="{{ asset('images/plantilla/admin/header-2-svg7.svg') }}"
                            alt="burger" />
                        <img class="dark:bg-white hidden" src="{{ asset('images/plantilla/admin/header-2-svg8.svg') }}"
                            alt="cross" />
                    </div>
                </div>
                ...
                <div class="lg:hidden flex flex-auto justify-between flex-row mt-4">
                    <div id="heading" class=" sm:block xl:pl-16 lg:pl-4">
                        ...
                        <h2 class=" font-bold text-xl leading-5 text-gray-800 dark:tet-white">Detalle del recibo</h2>
                    </div>
                    <div class="hidden sm:flex flex-row space-x-6 ">
                        ...
                        <button
                            ...
                            <p>Compartir</p>
                            <img src="{{ asset('images/plantilla/admin/header-2-svg3.svg') }}" alt="share" />
                        </button>
                    </div>
                </div>
                            ...
                            <div class="flex justify-between items-top">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="font-bold text-lg uppercase"> Recibo: </p>
                                        <p> {{ $recibo->clientes->razon_social }} </p>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <div>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @foreach ($recibo->detalles as $detalle)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap text-gray-600 truncate"> {{ $detalle->cantidad }}
                                    </td>
                                    <td class="whitespace-nowrap text-gray-600 truncate">{{ $detalle->precio }}</td>
                                    <td class="whitespace-nowrap text-gray-600 truncate"></td>
                                    <td class="whitespace-nowrap text-gray-600 truncate"> {{ $detalle->importe }}
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between mb-3">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-gray-800 text-sm total">{{ $recibo->total }}</div>
                            ...
                            {{-- <div class="flex justify-between">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-gray-800 text-sm total">{{ $recibo->impuesto }}</div>
                    ...
                    <div class="p-9 border-b border-gray-200">
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <p class="font-bold text-black text-lg"> {{ $recibo->total }} </p>
                            </div>
                        </div>
                    </div>
                </div>
