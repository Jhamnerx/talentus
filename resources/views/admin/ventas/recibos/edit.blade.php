...
@section('contenido')
    ...
    <div
        ...
        <div>
            <h4 class="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">EDITAR RECIBO</h4>
    ...
    <div class="p-6 shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-2 bg-gray-50 sm:p-6">
            ...
            {!! Form::model($recibo, [
                'route' => ['admin.ventas.recibos.update', $recibo],
                'method' => 'put',
                'class' => 'formularioRecibo',
            ]) !!}
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-dashed lg:border-r-2 pr-4 gap-2">
                    ...
                    <div class="col-span-12 mb-2">
                        ...
                        {!! Form::select(
                            'clientes_id',
                            [$recibo->clientes_id => $recibo->clientes->razon_social],
                            $recibo->clientes_id,
                            [
                    ...
                    <div class="col-span-12 mb-2">
                        ...
                        <div class="relative">
                            ...
                            {!! Form::text('numero', null, [
                                'placeholder' => '0012',
                                'class' => 'form-input w-full sm:w-2/4
                    ...
                    <div class="col-span-6 gap-2">
                        ...
                        <div class="relative">
                            ...
                            {!! Form::text('fecha', null, [
                                ...
                                'class' => 'form-input
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                valid:border-emerald-300
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                required:border-rose-300 invalid:border-rose-300 peer fechaEmision font-base pl-8 py-2
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                outline-none
                    ...
                    <div class="col-span-6 gap-2">
                        ...
                        <div class="relative">
                            ...
                            {!! Form::text('fecha_pago', null, [
                                'placeholder' => 'Selecciona la fecha',
                                'class' => 'form-input valid:border-emerald-300
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                required:border-rose-300 invalid:border-rose-300 peer fechaPago font-base pl-8 py-2
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                outline-none
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                focus:ring-primary-400 focus:outline-none focus:border-primary-400 block sm:text-sm
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                border-gray-200 rounded-md
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                text-black input w-full',
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <div class="flex">
                                <button id="productos-button"
                                    class="flex-shrink-0 z-10 hidden sm:inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                                    type="button">
                        ...
                        <div class="py-2 ml-auto mt-5 w-full sm:w-2/4 lg:w-1/4 mr-2">
                            <div class="flex justify-between mb-3">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-gray-800 text-sm total"> S/. {{ $recibo->subtotal }}</div>
                                    <input type="hidden" value="{{ $recibo->subtotal }}" class="subTotalRecibo"
                                        name="subtotal">
                                </div>
                            </div>
                            {{-- <div class="flex justify-between mb-4">
                                ...
                                <div class="text-right w-40">
                                    ...
                                    <input type="hidden" value="{{ $recibo->impuesto }}" class="impuestoRecibo"
                                        name="impuesto">
                                </div>
                            </div> --}}
                            ...
                            <div class="py-2 border-t border-b">
                                <div class="flex justify-between">
                                    ...
                                    <div class="text-right w-40">
                                        <div class="text-xl text-gray-800 font-bold totalRecibo">
                                            {{ $recibo->total }}</div>
                                        <input type="hidden" value="{{ $recibo->total }}" class="totalRecibo"
                                            name="total">
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            cont = {{ count($recibo->detalles) }};
            calculate_total('{{ $recibo->divisa }}');
            detalles = {{ count($recibo->detalles) }};
        ...
        function calculate_totales(divisa = "PEN") {
            ...
            if (divisa === "PEN") {
                ...
                $('.totalRecibo').html(simbolo + " " + numeral(totalRecibo).format('0,0.00'));


                // ENVIAR DATOS DE TOTAL A INPUTS
                $(".subTotalRecibo").val(numeral(total).format('0.00'));
                // $(".impuestoRecibo").val(numeral(igvTotal).format('0.00'));
                $(".totalRecibo").val(numeral(totalRecibo).format('0.00'));
        ...
        function evaluarGuardarRecibo() {
            ...
            if (detalles > 0) {
                $(".guardarRecibo").addClass('disabled');
            } else {
                $(".guardarRecibo").removeClass('disabled');
                cont = 0;
            }
        }
    </script>
    ...
    <script>
        $('.formularioRecibo').submit(function(e) {
            e.preventDefault();
