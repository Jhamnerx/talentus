...
<div class="p-6 shadow overflow-hidden sm:rounded-md">
    <div class="px-4 py-2 bg-gray-50 sm:p-6">
        ...
        {!! Form::model($presupuesto, ['route' => ['admin.ventas.presupuestos.update', $presupuesto], 'method' => 'put',
        ...
        <div class="grid grid-cols-12 gap-2">
            ...
            <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-dashed lg:border-r-2 pr-4 gap-2">
                ...
                <div class="col-span-12 mb-5">
                    ...
                    {!! Form::select('clientes_id', [$presupuesto->clientes_id =>
                    $presupuesto->clientes->razon_social], $presupuesto->clientes_id, ['class' => 'w-full clientes_id
                    pl-3', 'required']) !!}
                ...
                <div class="col-span-6 gap-2">
                    ...
                    <div class="relative">
                        ...
                        {!! Form::text('fecha', null, ['placeholder' => 'Selecciona la fecha','class' => 'form-input
                        valid:border-emerald-300
                ...
                <div class="col-span-6 gap-2">
                    ...
                    <div class="relative">
                        ...
                        {!! Form::text('fecha_caducidad', null, ['placeholder'=>
                        'Selecciona la fecha','class' => 'form-input
                        valid:border-emerald-300
            ...
            <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-red-600 lg:pl-6">
                ...
                <div class="col-span-6">
                    ...
                    {!! Form::select('divisa', ['PEN' => 'SOLES','USD' => 'USD'], null, ['class' => 'form-select
                        ...
                        <tbody class="text-sm divide-y divide-slate-200 listaItems">
                            ...
                            <tr class="main bg-slate-50">
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <textarea rows="4" class="form-input descripcion"
                            ...
                            <tr id="fila{{$loop->index}}">
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <textarea required name="items[{{$loop->index}}][producto]" class="form-input"
                                        rows="4">{{$detalle->producto}}</textarea>

                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <input required type="number" name="items[{{$loop->index}}][cantidad]" min="0"
                                        value="{{$detalle->cantidad}}" class="form-input cantidad"
                                        placeholder="Cantidad" value="2">
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <input required type="number" min="0" data-quantity="" step="0.01"
                                        name="items[{{$loop->index}}][precio]" value="{{$detalle->precio}}"
                                        class="form-input precio">
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <input type="number" value="{{$detalle->importe}}"
                                        name="items[{{$loop->index}}][importe]" class="form-input importe subtotal"
                                        readonly>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1">
                                        <button type="button" @click.prevent="eliminarDetalle({{$loop->index}})"
