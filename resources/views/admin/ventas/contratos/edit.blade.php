...
<div
    ...
    <div>
        <h4 class="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">EDITAR CONTRATO</h4>
...
<div class="mt-10 sm:mt-0">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 md:mt-0 md:col-span-3 col-span-3 mx-2 md:mx-6">
            ...
            {!! Form::model($contrato, ['route' => ['admin.ventas.contratos.update', $contrato], 'method' => 'put'])
            !!}
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            {!! Html::decode(Form::label('clientes_id','Cliente: <span class="text-rose-500">*</span>',
                            ['class'
                            => 'block text-sm font-medium mb-1'])) !!}
                            {!! Form::select('clientes_id', [$contrato->clientes_id =>
                            $contrato->clientes->razon_social], $contrato->clientes_id, ['class' => 'w-full clientes_id
                            pl-3']) !!}
                        ...
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <div class="relative">
                                {!! Form::text('fecha', null, ['placeholder' => 'yyyy-mm-dd', 'class' =>'form-input
                                ...
                                text-black input w-full', 'maxlength' => '10', 'required']) !!}
                        ...
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <div class="relative" wire:ignore>
                                ...
                                {!! Form::select('ciudades_id', [$contrato->ciudades->id =>
                                $contrato->ciudades->nombre], $contrato->ciudades_id, ['class' => 'form-select w-full
                                pl-9 ciudades']) !!}
                        ...
                        <div class="col-span-12 mt-10 pt-4 bg-white shadow-lg rounded-lg px-3 mb-5">
                            ...
                            @livewire('admin.ventas.contratos.modal-vehiculos', ['detalles' => $contrato->detalle],
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        {!! Form::submit('GUARDAR', ['class'=>'btnGuardarContrato btn bg-emerald-500
...
<script>
    function agregarVehiculo(vehiculo){
         ...
         */
            ...
            var fila= '<div class="filas flex -mx-1 px-2 py-4 border-b box-border" id="fila'+cont+'" idvehiculo="'+vehiculo.id+'">'+
                   '<div class="flex-auto px-1 md:px-5 lg:px-5 xl:w-32 text-left">'+
                    ...
                    '<div class="flex-auto xl:w-20 text-center">'+
                        ...
                        '<button type="button" class="text-red-500 hover:text-red-600 text-sm font-semibold" onclick="eliminarDetalleVehiculos('+cont+')">Eliminar</button>'+
                    '</div>'+
                '</div>';
