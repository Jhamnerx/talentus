...
<div class="p-6 shadow overflow-hidden sm:rounded-md">
    <div class="px-4 py-2 bg-gray-50 sm:p-6">
        {!! Form::open(['route' => 'admin.ventas.facturas.store', 'class' => 'formularioPresupuesto']) !!}
            ...
            <div class="col-span-12 grid grid-cols-12 md:col-span-6 border-dashed lg:border-r-2 pr-4 gap-2">
                ...
                <div class="col-span-6 gap-2">
                    ...
                    <div class="relative">
                        ...
                        <input name="fecha_emision" type="text"
...
<script>
    ...
    function add_item_to_table(){
        ...
        var fila = '<tr id="fila'+cont+'">'+
                ...
                '</td>'+
                '<td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">'+
                   '<input required type="number" name="items['+cont+'][cantidad]" min="0" value="'+cantidad+'" class="form-input cantidad" placeholder="Cantidad" >'+
                '</td>'+
                '<td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">'+
