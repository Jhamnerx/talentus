...
<div
    ...
    <div>
        <h4 class="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">CREAR proveedor</h4>
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1 ml-4">
            <div class="px-6 sm:px-2">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Formulario para editar un proveedor
                </h3>
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Html::decode(Form::label('razon_social','Razon Social: <span
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            {!! Html::decode(Form::label('numero_documento','DNI/RUC: <span
                                class="text-rose-500">*</span>',
                            ['class'
                            => 'block text-sm font-medium mb-1'])) !!}

                            {!! Form::text('numero_documento', null, ['placeholder' => 'Escribe el N° de documento
                            ','class' => 'form-input w-full valid:border-emerald-300
                            required:border-rose-300 invalid:border-rose-300 peer', 'required', 'maxlength' => '11'])
                            !!}
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Form::email('email', null, ['placeholder' => 'proveedors@correo.com','class' =>
                            'form-input w-full']) !!}
                            @error('email')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Form::text('web_site', null, ['placeholder' => 'Escribe el sitio web','class' =>
                            'form-input w-full']) !!}
                            @error('web_site')
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            !!}
                            {!! Form::text('direccion', null, ['placeholder' => 'Escribe la direccion...','class' =>
                            'form-input w-full']) !!}
