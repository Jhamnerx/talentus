...
<div
    ...
    <div>
        <h4 class="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">EDITAR DISPOSITIVO</h4>
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1 ml-4">
            <div class="px-6 sm:px-2">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Formulario para editar un dispositivo
                </h3>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            {!! Form::model($dispositivo, ['route' => ['admin.almacen.dispositivos.update', $dispositivo], 'method' =>
            'put'])
            !!}
            <div class="shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            {!! Html::decode(Form::label('imei','Imei <span class="text-rose-500">*</span>',
                            ['class'
                            => 'block text-sm font-medium mb-1'])) !!}

                            {!! Form::text('imei', null, ['placeholder' => 'Escribe un imei...','class' => 'form-input
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    {!! Form::submit('GUARDAR', ['class'=>'btn bg-emerald-600 hover:bg-emerald-600 focus:outline-none
