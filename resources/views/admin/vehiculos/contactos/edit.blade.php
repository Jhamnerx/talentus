...
@section('ruta', 'vehiculos-contactos')
...
<div
    ...
    <!-- Add customer button -->
    <a href="{{route('admin.vehiculos.contactos.index')}}">
...
<div class="mt-10 sm:mt-0">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2 mr-4 flotaEdit">


            {!! Form::model($contacto, ['route' => ['admin.vehiculos.contactos.update', $contacto], 'method' => 'put'])
            !!}
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Form::text('nombre', null, ['placeholder' => 'Escribe el nombre','class' =>
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Html::decode(Form::label('flotas_id','FLOTA: <span class="text-rose-500">*</span>',
                            ['class'
                            => 'block text-sm font-medium mb-1'])) !!}

                            {!! Form::select('flotas_id', [], $contacto->flotas_id, ['class' => 'pr-6
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Form::text('cargo', null, ['placeholder' => 'Escribe el cargo','class' =>
                            'form-input w-full']) !!}
                            @error('cargo')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="relative">
                                {!! Form::text('telefono', null, ['placeholder' => '987654321', 'class' => 'form-input
                                w-full pl-12', 'maxlength' => '9']) !!}
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            {!! Form::email('email', null, ['placeholder' => 'clientes@correo.com','class' =>
                            'form-input w-full']) !!}
                            @error('email')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            mb-1'])
                            !!}
                            {!! Form::textarea('descripcion', null, ['placeholder' => 'Escribe la direccion...','class'
                            =>
                            'form-input w-full']) !!}
...
// Fetch the preselected item, and add to the control
    // var studentSelect = $('.js-example-data-ajax');

    // // create the option and append to Select2
    // var name = {{$contacto->flotas->nombre}};
    // var option = new Option(name, {{$contacto->flotas_id}}, true, true);
