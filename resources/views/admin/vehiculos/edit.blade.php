                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                pl-9
                                valid:border-emerald-300
                                required:border-rose-300 invalid:border-rose-300 peer numero', 'required']) !!}
                                <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                'class' => 'form-input w-full pl-9 operador', 'disabled']) !!}
                                <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                {!! Form::text('sim_card', $vehiculo->sim_card->sim_card, ['placeholder' =>
                                '3189219220212', 'class' =>
                                'form-input w-full pl-9 sim_card', 'disabled', 'required']) !!}
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                {!! Form::text('dispositivo', $vehiculo->dispositivos->imei, ['placeholder' =>
                                '357073292893290', 'class' =>
                                'form-input w-full
                                pl-9
                                valid:border-emerald-300
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                {!! Form::text('modelo_id', $vehiculo->dispositivos->modelo->modelo, ['placeholder' =>
                                'FMB920', 'class' => 'form-input w-full pl-9 modelo_gps', 'disabled']) !!}
                                <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                {!! Form::textarea('descripcion', null, ['placeholder' => 'Ingresar Descripcion',
                                'class' => 'form-input w-full pl-9', 'rows' => 2]) !!}
