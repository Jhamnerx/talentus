<footer class="site-footer site-footer__two">
    ...
    <img src="{{ Vite::asset('resources/images/cliente/footer-bg-2-1.png') }}" class="site-footer__shape-2" alt="">
    <img src="{{ Vite::asset('resources/images/cliente/footer-bg-2-2.png') }}" class="site-footer__shape-3" alt="">
