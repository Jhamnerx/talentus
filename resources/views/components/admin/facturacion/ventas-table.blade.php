                                ...
                                @if ($venta->tipo_comprobante_id != '02')
                                    <div class="space-x-1">
                                        ...
                                        @switch($venta->fe_estado)
                                            {{-- OBTENER CDR --}}
                                            @case('0')
                                                <x-form.button.circle flat wire:click.prevent="getCdr({{ $venta->id }})"
                                                    teal icon="refresh" spinner='getCdr({{ $venta->id }})' />
                                            @break
                                            ...
                                            @switch($venta->fe_estado)
                                                ...
                                                @case('0')
                                                    <x-form.button.circle flat
                                                        wire:click.prevent="getCdr({{ $venta->id }})" teal icon="refresh"
                                                        spinner='getCdr({{ $venta->id }})' />
                                                @break
