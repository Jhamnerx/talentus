                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div>{{ $nota->fecha_emision->format('d-m-Y / H:i:s') }}
                            </div>
                        </td>
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium text-sky-500">
                                @switch($nota->tipo_comprobante_id)
                                @case('07')
                                NOTA DE CRÉDITO {{ $nota->serie_correlativo }}
                                @break

                                @case('08')
                                NOTA DE DEBITO {{ $nota->serie_correlativo }}
                                @break
                                @endswitch
                            </div>
                        </td>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3">
                            ...
                            <div class="font-medium text-sky-500">
                                @if ($nota->comprobante)
                                @switch($nota->comprobante->tipo_comprobante_id)
                                @case('01')
                                FACTURA-{{ $nota->comprobante->serie_correlativo }}
                                @break

                                @case('02')
                                NOTA DE VENTA-{{ $nota->comprobante->serie_correlativo }}
                                @break

                                @case('03')
                                BOLETA DE VENTA-{{ $nota->comprobante->serie_correlativo }}
                                @break
                                @endswitch
                                @endif
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            ...
                            <div class="space-x-1">
                                ...
                                {{-- OBTENER CDR --}}
                                @case('0')
                                <x-form.mini.button flat wire:click.prevent="getCdr({{ $nota->id }})" teal
                                    icon="arrow-path" spinner='getCdr({{ $nota->id }})' />
                                @break
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <div class="py-1" role="menu" aria-orientation="vertical"
                                            ...
                                            <div
                                                ...
                                                <div class="w-full">
                                                    <x-form.badge indigo md label="{{ $nota->serie_correlativo }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="w-full">
                                                    <x-form.badge indigo md label="{{ $nota->estado_texto }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="w-full">
                                                    <x-form.badge indigo md label="{{ $nota->code_sunat }}" />
                                                </div>
                                            </div>
                                            <div
                                                class="flex flex-nowrap px-4 py-2 text-sm hover:bg-gray-100 hover:text-gray-900">
