            ...
            <table class="table-auto w-full">
                ...
                <thead
                    ...
                    <tr>
                        ...
                        @can('tecnico.tareas.cards.pendient.actions')
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach ($tareas as $tarea)
                        <tr wire:key='tpd-{{ $tarea->id }}'>
                                ...
                                <td class="px-8 first:pl-5 last:pr-5 py-3 ">
                                    <div class="flex gap-2 justify-center">
                                        <div class="relative" x-data="{ open: false }" @mouseenter="open = true"
                                            ...
                                            <button wire:click="openModalNotificationClient({{ $tarea->id }})"
                                                ...
                                                <svg class="w-10 h-10 shrink-0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <path fill='{{ !$tarea->sent_message ? '#25d366' : '#67DF93' }}'
                                        ...
                                        <div class="relative" x-data="{ open: false }" @mouseenter="open = true"
                                            @mouseleave="open = false">
                                            <button type="button" wire:click.prevent="markComplete({{ $tarea->id }})"
                                                aria-haspopup="true" :aria-expanded="open" @focus="open = true"
                                                @focusout="open = false" @click.prevent type="button"
                                                class="btn rounded-full bg-emerald-600 hover:bg-emerald-700 text-white">
                            ...
                            @endcan
                            <td class="px-2 first:pl-5 last:pr-2 py-3 max-w-xs" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                @else
                                    <div x-show="!isUploading"
                                        class="flex px-2 gap-2 justify-center hover:cursor-pointer">
