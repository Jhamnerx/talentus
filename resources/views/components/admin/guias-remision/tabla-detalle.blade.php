        ...
        <tbody class="text-sm divide-y divide-slate-200 listaItems">
            ...
            <tr class="main bg-slate-50 pt-4">
                ...
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <x-form.number wire:model.live="selected.cantidad" min="1" step="1" min='1'
                ...
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                    <div class="space-x-1">
                        <x-form.mini.button wire:click="addProducto" spinner="addProducto" teal icon="check" />
                    </div>
                </td>
            ...
            <tr wire:key="item-{{ $clave }}-{{ $item['producto_id'] }}">
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <input type="text" wire:model.live="items.{{ $clave }}.codigo" class="form-input" readonly>
                ...
                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <textarea required wire:model.live="items.{{ $clave }}.descripcion" class="form-textarea"
                        rows="4"></textarea>
                </td>
