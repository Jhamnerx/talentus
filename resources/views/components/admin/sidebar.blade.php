            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 @if (in_array(Request::segment(2), ['work-orders'])) {{ 'from-violet-500/12 dark:from-violet-500/24 to-violet-500/4' }} @endif">
                        <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if (Route::is('work-orders.index')) {{ 'text-violet-500!' }} @endif"
                            href="{{ route('work-orders.index') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 h-6 w-6 @if (Route::is('work-orders.index')) {{ 'text-violet-500' }}@else{{ 'text-gray-400 dark:text-gray-500' }} @endif" 
