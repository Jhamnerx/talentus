...
class CodigosDetraccionesSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $codigos = [
            ...
            [
                'codigo' =>  "011",
                'descripcion' => "Bienes gravados con el IGV, o renuncia a la exoneración",
                'porcentaje' => '10.00'
            ],
            [
                'codigo' =>  "012",
            ...
            [
                'codigo' =>  "032",
                'descripcion' => "Paprika y otros frutos de los generos capsicum o pimienta",
                'porcentaje' => '10.00'
            ],
            [
                'codigo' =>  "034",
